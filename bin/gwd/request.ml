...
let treat_request =
  ...
  then begin
    ...
    then begin
        ...
        | "N" ->
          w_base @@ fun conf base -> begin match Geneweb.Util.p_getenv conf.env "v" with
            | Some v -> Geneweb.Name_display.surname_print conf base Geneweb.Name_display.surname_not_found v
        ...
        | "NG" -> w_base @@ begin fun conf base ->
            ...
            | Some "input" | None ->
              ...
              let search n =
                ...
                match pl with
                | [] ->
                  Geneweb.Name_display.surname_print conf base unknown n
                | [p] ->
                  if sosa_acc
              ...
              begin match real_input "v" with
                ...
                | None ->
                  ...
                  | Some fn, None ->
                    Geneweb.Name_display.first_name_print conf base fn
                  | None, Some sn ->
                    Geneweb.Name_display.surname_print conf base unknown sn
        ...
        | "P" ->
          w_base @@ fun conf base -> begin match Geneweb.Util.p_getenv conf.env "v" with
            | Some v -> Geneweb.Name_display.first_name_print conf base v
