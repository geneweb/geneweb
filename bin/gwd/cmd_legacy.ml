...
let conn_timeout = ref (Float.to_int Cmd.default_http_timeout)
...
let max_pending_requests = ref Cmd.default_http_max_requests
...
let selected_port = ref Cmd.default_http_port
