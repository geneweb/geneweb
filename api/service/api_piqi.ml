...
and gen__person code x =
  ...
  Piqirun.gen_record code (_sosa :: _n :: _p :: _oc :: _sex :: _lastname :: _firstname :: _public_name :: _image :: _birth_date :: _birth_place :: _baptism_date :: _baptism_place :: _death_date :: _death_place :: _death_type :: _burial_date :: _burial_place :: _spouses :: _ascend :: _descend :: _visible_for_visitors :: [])
...
and gen__full_person code x =
  ...
  Piqirun.gen_record code (_sosa :: _n :: _p :: _oc :: _index :: _sex :: _lastname :: _firstname :: _public_name :: _aliases :: _qualifiers :: _firstname_aliases :: _surname_aliases :: _image :: _birth_date :: _birth_place :: _birth_src :: _baptism_date :: _baptism_place :: _baptism_src :: _death_date :: _death_place :: _death_src :: _death_type :: _burial_date :: _burial_place :: _burial_src :: _occupation :: _psources :: _titles :: _related :: _rparents :: _visible_for_visitors :: _parents :: _families :: [])
