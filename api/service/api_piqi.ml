module rec Api_piqi :
             sig
               ...
               type title_type =
                 [ | `title_main | `title_name | `title_none
                 ]
               
               type search_type =
                 [ | `starting_with | `approximative | `lastname_or_firstname
                 ]
               ...
               type warning_bad_sex_of_married_person =
               ...
               type warning_changed_order_of_children =
                 Warning_changed_order_of_children.
                 t
               
               type warning_changed_order_of_marriages =
                 Warning_changed_order_of_marriages.
                 t
               
               type warning_children_not_in_order =
                 Warning_children_not_in_order.
                 t
               
               type warning_dead_too_early_to_be_father =
                 Warning_dead_too_early_to_be_father.
                 t
               
               type warning_incoherent_ancestor_date =
                 Warning_incoherent_ancestor_date.
                 t
               
               type warning_marriage_date_after_death =
                 Warning_marriage_date_after_death.
                 t
               
               type warning_marriage_date_before_birth =
                 Warning_marriage_date_before_birth.
                 t
               
               type warning_mother_dead_before_child_birth =
                 Warning_mother_dead_before_child_birth.
                 t
               
               type warning_parent_born_after_child =
               ...
               type warning_big_age_between_spouses =
               ...
               type warning_witness_date_after_death =
                 Warning_witness_date_after_death.
                 t
               
               type warning_witness_date_before_birth =
                 Warning_witness_date_before_birth.
                 t
               
               type warning_changed_order_of_family_events =
                 Warning_changed_order_of_family_events.
                 t
               
               type warning_changed_order_of_person_events =
                 Warning_changed_order_of_person_events.
                 t
               
               type warning_fevent_order = Warning_fevent_order.t
               
               type warning_fwitness_event_after_death =
                 Warning_fwitness_event_after_death.
                 t
               
               type warning_fwitness_event_before_birth =
                 Warning_fwitness_event_before_birth.
                 t
               
               type warning_pevent_order = Warning_pevent_order.t
               
               type warning_pwitness_event_after_death =
                 Warning_pwitness_event_after_death.
                 t
               
               type warning_pwitness_event_before_birth =
                 Warning_pwitness_event_before_birth.
                 t
               ...
               type notification_birthday_params =
                 Notification_birthday_params.
                 t
...
and
  Reference_person :
    sig
      type t =
        { mutable n : string; mutable p : string;
          mutable oc : Api_piqi.protobuf_int32
        }
      
    end = Reference_person
and
  List_reference_persons :
    sig
      type t = { mutable list_ref_persons : Api_piqi.reference_person list }
    ...
    sig
      type t =
        { mutable title_type : Api_piqi.title_type;
          mutable name : string option; mutable title : string option;
          mutable fief : string option; mutable date_begin : string option;
...
and
  Spouse :
    sig
      type t =
        { mutable sosa : string; mutable n : string; mutable p : string;
          mutable oc : Api_piqi.protobuf_int32; mutable sex : Api_piqi.sex;
          mutable lastname : string; mutable firstname : string;
          mutable public_name : string option; mutable image : string;
          mutable birth_date : string; mutable birth_place : string;
          mutable baptism_date : string; mutable baptism_place : string;
          mutable death_date : string; mutable death_place : string;
          mutable death_type : Api_piqi.death_type;
          mutable burial_date : string; mutable burial_place : string;
          mutable marriage_date : string; mutable marriage_place : string;
    ...
    sig
      type t =
        { mutable sosa : string; mutable n : string; mutable p : string;
          ...
          mutable death_type : Api_piqi.death_type;
          mutable burial_date : string; mutable burial_place : string;
          mutable spouses : Api_piqi.spouse list; mutable ascend : bool;
          mutable descend : bool; mutable visible_for_visitors : bool
        }
    ...
    sig
      type t =
        { mutable sosa : string; mutable n : string; mutable p : string;
          ...
          mutable sex : Api_piqi.sex; mutable lastname : string;
          mutable firstname : string; mutable public_name : string option;
          mutable aliases : string list; mutable qualifiers : string list;
...
and
  Internal_int32 :
    sig type t = { mutable value : Api_piqi.protobuf_int32 }
         end =
    Internal_int32
and
  List_persons :
    sig type t = { mutable list_persons : Api_piqi.person list }
         end =
    List_persons
and
  List_full_persons :
    sig type t = { mutable persons : Api_piqi.full_person list }
         end =
    List_full_persons
and
  List_full_families :
    sig type t = { mutable families : Api_piqi.full_family list }
         end =
    List_full_families
and
  Search_params :
    sig
      type t =
        { mutable search_type : Api_piqi.search_type;
          ...
          mutable firstname : string option; mutable only_sosa : bool;
          mutable only_recent : bool; mutable maiden_name : bool
        }
      
    end = Search_params
and
  Image :
    sig type t = { mutable person : Api_piqi.person; mutable img : string }
...
and
  Full_image :
    sig
      type t =
        { mutable person : Api_piqi.full_person; mutable img : string
        }
      
    end = Full_image
and
  List_images :
    sig type t = { mutable list_images : Api_piqi.image list }
         end =
    List_images
and
  List_full_images :
    sig type t = { mutable images : Api_piqi.full_image list }
         end =
    List_full_images
and
  Pers_img :
    sig
      type t =
        { mutable person : Api_piqi.reference_person; mutable img : string
        }
      
    end = Pers_img
and
  List_pers_img :
    sig type t = { mutable list_pers_img : Api_piqi.pers_img list }
         end =
    List_pers_img
and
  Index : sig type t = { mutable index : Api_piqi.protobuf_int32 }
               end =
    Index
and Image_address : sig type t = { mutable img : string }
                         end = Image_address
and
    ...
    sig
      type t =
        { mutable person : Api_piqi.reference_person;
          ...
          mutable spouse_ascend : bool; mutable only_recent : bool
        }
...
and
  List_person_relation :
    sig type t = { mutable person_relations : Api_piqi.person_relation list }
        
    end = List_person_relation
and
  List_full_person_relation :
    sig
      type t =
...
and
  Anniversary_params :
    sig type t = { mutable month : Api_piqi.protobuf_int32 option }
         end =
    Anniversary_params
and
  Graph_params :
...
and
  Warning_already_defined :
    sig type t = { mutable person : Api_piqi.full_person }
         end =
    Warning_already_defined
and
...
and
  Warning_parent_too_young :
    sig
      type t =
        { mutable parent : Api_piqi.full_person; mutable date : string
        }
...
and
  Warning_young_for_marriage :
    sig
      type t =
        { mutable person : Api_piqi.full_person; mutable date : string
        }
...
and
  Warning_big_age_between_spouses :
    sig
      type t =
        { mutable father : Api_piqi.full_person;
          mutable mother : Api_piqi.full_person; mutable date : string
        }
...
and
  Warning_changed_order_of_person_events :
    ...
    Warning_changed_order_of_person_events
and
  Warning_fevent_order :
    sig
      type t =
        { mutable person : Api_piqi.full_person; mutable event1 : string;
...
and
  Warning_fwitness_event_after_death :
    sig
      type t =
        { mutable person : Api_piqi.full_person; mutable event : string
        }
...
and
  Base_warnings :
    sig
      type t =
        {
          mutable warning_already_defined :
          Api_piqi.warning_already_defined list;
          mutable warning_own_ancestor : Api_piqi.warning_own_ancestor list;
          mutable warning_bad_sex_of_married_person :
          Api_piqi.warning_bad_sex_of_married_person list;
          mutable warning_birth_after_death :
          Api_piqi.warning_birth_after_death list;
          mutable warning_incoherent_sex :
          Api_piqi.warning_incoherent_sex list;
          mutable warning_changed_order_of_children :
          Api_piqi.warning_changed_order_of_children list;
          mutable warning_children_not_in_order :
          Api_piqi.warning_children_not_in_order list;
          mutable warning_dead_too_early_to_be_father :
          Api_piqi.warning_dead_too_early_to_be_father list;
          mutable warning_incoherent_ancestor_date :
          Api_piqi.warning_incoherent_ancestor_date list;
          mutable warning_marriage_date_after_death :
          Api_piqi.warning_marriage_date_after_death list;
          mutable warning_marriage_date_before_birth :
          Api_piqi.warning_marriage_date_before_birth list;
          mutable warning_mother_dead_before_child_birth :
          Api_piqi.warning_mother_dead_before_child_birth list;
          mutable warning_parent_born_after_child :
          Api_piqi.warning_parent_born_after_child list;
          mutable warning_parent_too_young :
          Api_piqi.warning_parent_too_young list;
          mutable warning_title_dates_error :
          Api_piqi.warning_title_dates_error list;
          mutable warning_undefined_sex : Api_piqi.warning_undefined_sex list;
          mutable warning_young_for_marriage :
          Api_piqi.warning_young_for_marriage list;
          mutable warning_close_children :
          Api_piqi.warning_close_children list;
          mutable warning_parent_too_old :
          Api_piqi.warning_parent_too_old list;
          mutable warning_changed_order_of_marriages :
          Api_piqi.warning_changed_order_of_marriages list;
          mutable warning_big_age_between_spouses :
          Api_piqi.warning_big_age_between_spouses list;
          mutable warning_dead_old : Api_piqi.warning_dead_old list;
          mutable warning_old_individual :
          Api_piqi.warning_old_individual list;
          mutable warning_witness_date_after_death :
          Api_piqi.warning_witness_date_after_death list;
          mutable warning_witness_date_before_birth :
          Api_piqi.warning_witness_date_before_birth list
        }
    ...
    sig
      type t =
        { mutable date_begin : Api_piqi.filter_date;
          mutable date_end : Api_piqi.filter_date; mutable only_exact : bool
        }
...
and
  Filters :
    sig
      type t =
        { mutable only_sosa : bool; mutable only_recent : bool;
          mutable sex : Api_piqi.sex option; mutable nb_results : bool;
...
and
  Synchro_params :
    sig
      type t =
        { mutable export_directory : string; mutable timestamp : string
        }
...
and
  Correspondance :
    sig
      type t =
        { mutable base : string; mutable person : Api_piqi.person;
...
and
  Correspondance_list :
    sig type t = { mutable correspondances : Api_piqi.correspondance list }
...
and parse_infos_base x =
  ...
  let (_nb_families, x) =
    Piqirun.parse_required_field 2 parse_protobuf_int64 x in
  let (_sosa, x) = Piqirun.parse_optional_field 3 parse_reference_person x in
  let (_last_modified_person, x) =
    Piqirun.parse_optional_field 4 parse_protobuf_int64 x
  in
...
and parse_reference_person x =
  ...
  let (_oc, x) = Piqirun.parse_required_field 3 parse_protobuf_int32 x
  in
    (Piqirun.check_unparsed_fields x;
     {
...
and parse_list_reference_persons x =
  let x = Piqirun.parse_record x in
  let (_list_ref_persons, x) =
    Piqirun.parse_repeated_field 1 parse_reference_person x
  in
    (Piqirun.check_unparsed_fields x;
...
and parse_relation_parent x =
  ...
  let (_rpt_type, x) =
    Piqirun.parse_required_field 4 parse_relation_parent_type x
  in
    (Piqirun.check_unparsed_fields x;
     {
...
and parse_title x =
  ...
  let (_nth, x) = Piqirun.parse_optional_field 7 parse_protobuf_int32 x
  in
    (Piqirun.check_unparsed_fields x;
     {
...
and parse_spouse x =
  ...
  let (_death_type, x) =
    Piqirun.parse_required_field 16 parse_death_type x in
  ...
  let (_marriage_place, x) =
    Piqirun.parse_required_field 20 parse_string x in
  let (_divorce_type, x) =
    Piqirun.parse_required_field 21 parse_divorce_type x in
  let (_visible_for_visitors, x) =
    Piqirun.parse_required_field 22 parse_bool x
  in
    (Piqirun.check_unparsed_fields x;
     {
       Spouse.sosa = _sosa;
...
and parse_full_person x =
  ...
  let (_surname_aliases, x) =
    Piqirun.parse_repeated_field 13 parse_string x in
  ...
  let (_death_type, x) =
    Piqirun.parse_required_field 25 parse_death_type x in
  ...
  let (_related, x) =
    Piqirun.parse_repeated_field 33 parse_internal_int32 x in
  let (_rparents, x) =
    Piqirun.parse_repeated_field 34 parse_relation_parent x in
  let (_visible_for_visitors, x) =
    Piqirun.parse_required_field 35 parse_bool x in
  let (_parents, x) =
    Piqirun.parse_optional_field 36 parse_protobuf_int32 x in
  let (_families, x) = Piqirun.parse_repeated_field 37 parse_internal_int32 x
  in
    (Piqirun.check_unparsed_fields x;
     {
...
and parse_full_family x =
  ...
  let (_marriage_type, x) =
    Piqirun.parse_required_field 5 parse_marriage_type x in
  let (_divorce_type, x) =
    Piqirun.parse_required_field 6 parse_divorce_type x in
  let (_divorce_date, x) = Piqirun.parse_optional_field 7 parse_string x in
  let (_witnesses, x) =
    Piqirun.parse_repeated_field 8 parse_internal_int32 x in
  let (_father, x) = Piqirun.parse_required_field 9 parse_protobuf_int32 x in
  let (_mother, x) =
    Piqirun.parse_required_field 10 parse_protobuf_int32 x in
  let (_children, x) =
    Piqirun.parse_repeated_field 11 parse_internal_int32 x in
  let (_index, x) = Piqirun.parse_required_field 12 parse_protobuf_int32 x
  in
    (Piqirun.check_unparsed_fields x;
     {
...
and parse_internal_int32 x =
  let x = Piqirun.parse_record x in
  let (_value, x) = Piqirun.parse_required_field 1 parse_protobuf_int32 x
  in (Piqirun.check_unparsed_fields x; { Internal_int32.value = _value; })
and parse_list_persons x =
  let x = Piqirun.parse_record x in
  let (_list_persons, x) = Piqirun.parse_repeated_field 1 parse_person x
  in
    (Piqirun.check_unparsed_fields x;
     { List_persons.list_persons = _list_persons; })
and parse_list_full_persons x =
  let x = Piqirun.parse_record x in
  let (_persons, x) = Piqirun.parse_repeated_field 1 parse_full_person x
  in
    (Piqirun.check_unparsed_fields x;
     { List_full_persons.persons = _persons; })
and parse_list_full_families x =
  let x = Piqirun.parse_record x in
  let (_families, x) = Piqirun.parse_repeated_field 1 parse_full_family x
  in
    (Piqirun.check_unparsed_fields x;
...
and parse_search_params x =
  let x = Piqirun.parse_record x in
  let (_search_type, x) =
    Piqirun.parse_required_field 1 parse_search_type x ~default: "\b\000" in
  ...
  let (_only_sosa, x) =
    Piqirun.parse_required_field 4 parse_bool x ~default: "\b\000" in
  let (_only_recent, x) =
    Piqirun.parse_required_field 5 parse_bool x ~default: "\b\000" in
  let (_maiden_name, x) =
    Piqirun.parse_required_field 6 parse_bool x ~default: "\b\000"
  in
    (Piqirun.check_unparsed_fields x;
     {
...
and parse_image x =
  ...
  let (_img, x) = Piqirun.parse_required_field 2 parse_string x
  in
    (Piqirun.check_unparsed_fields x;
     { Image.person = _person; Image.img = _img; })
and parse_full_image x =
  ...
  in
    (Piqirun.check_unparsed_fields x;
     { Full_image.person = _person; Full_image.img = _img; })
and parse_list_images x =
  let x = Piqirun.parse_record x in
  let (_list_images, x) = Piqirun.parse_repeated_field 1 parse_image x
  in
    (Piqirun.check_unparsed_fields x;
     { List_images.list_images = _list_images; })
and parse_list_full_images x =
  let x = Piqirun.parse_record x in
  let (_images, x) = Piqirun.parse_repeated_field 1 parse_full_image x
  in
    (Piqirun.check_unparsed_fields x; { List_full_images.images = _images; })
and parse_pers_img x =
  let x = Piqirun.parse_record x in
  let (_person, x) =
    Piqirun.parse_required_field 1 parse_reference_person x in
  let (_img, x) = Piqirun.parse_required_field 2 parse_string x
  in
    (Piqirun.check_unparsed_fields x;
     { Pers_img.person = _person; Pers_img.img = _img; })
and parse_list_pers_img x =
  let x = Piqirun.parse_record x in
  let (_list_pers_img, x) = Piqirun.parse_repeated_field 1 parse_pers_img x
  in
    (Piqirun.check_unparsed_fields x;
...
and parse_index x =
  ...
  in (Piqirun.check_unparsed_fields x; { Index.index = _index; })
and parse_image_address x =
  let x = Piqirun.parse_record x in
  let (_img, x) = Piqirun.parse_required_field 1 parse_string x
  in (Piqirun.check_unparsed_fields x; { Image_address.img = _img; })
and parse_close_persons_params x =
  let x = Piqirun.parse_record x in
  let (_person, x) =
    Piqirun.parse_required_field 1 parse_reference_person x in
  let (_nb_gen_asc, x) =
    Piqirun.parse_optional_field 2 parse_protobuf_int32 x in
  let (_nb_gen_desc, x) =
    Piqirun.parse_optional_field 3 parse_protobuf_int32 x in
  let (_spouse_ascend, x) =
    Piqirun.parse_required_field 4 parse_bool x ~default: "\b\000" in
  let (_only_recent, x) =
    Piqirun.parse_required_field 5 parse_bool x ~default: "\b\000"
  in
    (Piqirun.check_unparsed_fields x;
     {
...
and parse_person_relation x =
  let x = Piqirun.parse_record x in
  let (_person, x) = Piqirun.parse_required_field 1 parse_person x in
  let (_relation, x) = Piqirun.parse_required_field 2 parse_relation_type x
  in
    (Piqirun.check_unparsed_fields x;
     {
...
and parse_list_person_relation x =
  let x = Piqirun.parse_record x in
  let (_person_relations, x) =
    Piqirun.parse_repeated_field 1 parse_person_relation x
  in
    (Piqirun.check_unparsed_fields x;
...
and parse_list_full_person_relation x =
  let x = Piqirun.parse_record x in
  let (_person_relations, x) =
    Piqirun.parse_repeated_field 1 parse_full_person_relation x
  in
    (Piqirun.check_unparsed_fields x;
     { List_full_person_relation.person_relations = _person_relations; })
and parse_anniversary_params x =
  let x = Piqirun.parse_record x in
  let (_month, x) = Piqirun.parse_optional_field 1 parse_protobuf_int32 x
  in
    (Piqirun.check_unparsed_fields x; { Anniversary_params.month = _month; })
and parse_graph_params x =
  let x = Piqirun.parse_record x in
  let (_generation, x) =
    Piqirun.parse_optional_field 1 parse_protobuf_int32 x in
  let (_person, x) = Piqirun.parse_required_field 2 parse_reference_person x
  in
    (Piqirun.check_unparsed_fields x;
     { Graph_params.generation = _generation; Graph_params.person = _person;
     })
and parse_graph_rel_params x =
  let x = Piqirun.parse_record x in
  let (_person1, x) =
    Piqirun.parse_required_field 1 parse_reference_person x in
  let (_person2, x) = Piqirun.parse_required_field 2 parse_reference_person x
  in
    (Piqirun.check_unparsed_fields x;
     {
...
and parse_cpl_rel_params x =
  ...
  in
    (Piqirun.check_unparsed_fields x;
     { Cpl_rel_params.person1 = _person1; Cpl_rel_params.person2 = _person2;
     })
and parse_node x =
  let x = Piqirun.parse_record x in
  let (_id, x) = Piqirun.parse_required_field 1 parse_protobuf_int64 x in
  let (_person, x) = Piqirun.parse_required_field 2 parse_person x
  in
    (Piqirun.check_unparsed_fields x;
     { Node.id = _id; Node.person = _person; })
and parse_full_node x =
  let x = Piqirun.parse_record x in
  let (_id, x) = Piqirun.parse_required_field 1 parse_protobuf_int64 x in
  let (_person, x) = Piqirun.parse_required_field 2 parse_full_person x
  in
    (Piqirun.check_unparsed_fields x;
     { Full_node.id = _id; Full_node.person = _person; })
and parse_edge x =
  let x = Piqirun.parse_record x in
  let (_from_node, x) =
    Piqirun.parse_required_field 1 parse_protobuf_int64 x in
...
and parse_graph x =
  ...
  let (_edges, x) = Piqirun.parse_repeated_field 2 parse_edge x
  in
    (Piqirun.check_unparsed_fields x;
     { Graph.nodes = _nodes; Graph.edges = _edges; })
and parse_full_graph x =
  ...
  let (_families, x) = Piqirun.parse_repeated_field 3 parse_full_family x
  in
    (Piqirun.check_unparsed_fields x;
     {
...
and parse_all_persons_params x =
  ...
  let (_limit, x) = Piqirun.parse_optional_field 2 parse_protobuf_int32 x
  in
    (Piqirun.check_unparsed_fields x;
     { All_persons_params.from = _from; All_persons_params.limit = _limit; })
and parse_all_families_params x =
  ...
  in
    (Piqirun.check_unparsed_fields x;
     { All_families_params.from = _from; All_families_params.limit = _limit;
     })
and parse_warning_already_defined x =
  let x = Piqirun.parse_record x in
  let (_person, x) = Piqirun.parse_required_field 1 parse_full_person x
  in
    (Piqirun.check_unparsed_fields x;
...
and parse_warning_changed_order_of_children x =
  ...
  let (_mother, x) = Piqirun.parse_required_field 2 parse_full_person x
  in
    (Piqirun.check_unparsed_fields x;
     {
...
and parse_warning_dead_too_early_to_be_father x =
  ...
  let (_father, x) = Piqirun.parse_required_field 2 parse_full_person x
  in
    (Piqirun.check_unparsed_fields x;
     {
...
and parse_warning_incoherent_ancestor_date x =
  let x = Piqirun.parse_record x in
  let (_person, x) = Piqirun.parse_required_field 1 parse_full_person x in
  let (_ancestor, x) = Piqirun.parse_required_field 2 parse_full_person x
  in
    (Piqirun.check_unparsed_fields x;
     {
...
and parse_warning_mother_dead_before_child_birth x =
  ...
  let (_child, x) = Piqirun.parse_required_field 2 parse_full_person x
  in
    (Piqirun.check_unparsed_fields x;
     {
...
and parse_warning_parent_too_young x =
  let x = Piqirun.parse_record x in
  let (_parent, x) = Piqirun.parse_required_field 1 parse_full_person x in
  let (_date, x) = Piqirun.parse_required_field 2 parse_string x
  in
    (Piqirun.check_unparsed_fields x;
     {
...
and parse_warning_close_children x =
  ...
  let (_child2, x) = Piqirun.parse_required_field 4 parse_full_person x
  in
    (Piqirun.check_unparsed_fields x;
     {
...
and parse_warning_big_age_between_spouses x =
  ...
  let (_father, x) = Piqirun.parse_required_field 1 parse_full_person x in
  let (_mother, x) = Piqirun.parse_required_field 2 parse_full_person x in
  let (_date, x) = Piqirun.parse_required_field 3 parse_string x
  in
    (Piqirun.check_unparsed_fields x;
     {
...
and parse_warning_dead_old x =
  ...
  in
    (Piqirun.check_unparsed_fields x;
     { Warning_dead_old.person = _person; Warning_dead_old.date = _date; })
...
and parse_warning_fevent_order x =
  ...
  let (_event2, x) = Piqirun.parse_required_field 3 parse_string x
  in
    (Piqirun.check_unparsed_fields x;
     {
...
and parse_warning_fwitness_event_after_death x =
  let x = Piqirun.parse_record x in
  let (_person, x) = Piqirun.parse_required_field 1 parse_full_person x in
  let (_event, x) = Piqirun.parse_required_field 2 parse_string x
  in
    (Piqirun.check_unparsed_fields x;
     {
...
and parse_base_warnings x =
  let x = Piqirun.parse_record x in
  let (_warning_already_defined, x) =
    Piqirun.parse_repeated_field 1 parse_warning_already_defined x in
  let (_warning_own_ancestor, x) =
    Piqirun.parse_repeated_field 2 parse_warning_own_ancestor x in
  let (_warning_bad_sex_of_married_person, x) =
    Piqirun.parse_repeated_field 3 parse_warning_bad_sex_of_married_person x in
  let (_warning_birth_after_death, x) =
    Piqirun.parse_repeated_field 4 parse_warning_birth_after_death x in
  let (_warning_incoherent_sex, x) =
    Piqirun.parse_repeated_field 5 parse_warning_incoherent_sex x in
  let (_warning_changed_order_of_children, x) =
    Piqirun.parse_repeated_field 6 parse_warning_changed_order_of_children x in
  let (_warning_children_not_in_order, x) =
    Piqirun.parse_repeated_field 7 parse_warning_children_not_in_order x in
  let (_warning_dead_too_early_to_be_father, x) =
    Piqirun.parse_repeated_field 8 parse_warning_dead_too_early_to_be_father
      x in
  let (_warning_incoherent_ancestor_date, x) =
    Piqirun.parse_repeated_field 9 parse_warning_incoherent_ancestor_date x in
  let (_warning_marriage_date_after_death, x) =
    Piqirun.parse_repeated_field 10 parse_warning_marriage_date_after_death x in
  let (_warning_marriage_date_before_birth, x) =
    Piqirun.parse_repeated_field 11 parse_warning_marriage_date_before_birth
      x in
  let (_warning_mother_dead_before_child_birth, x) =
    Piqirun.parse_repeated_field 12
      parse_warning_mother_dead_before_child_birth x in
  let (_warning_parent_born_after_child, x) =
    Piqirun.parse_repeated_field 13 parse_warning_parent_born_after_child x in
  let (_warning_parent_too_young, x) =
    Piqirun.parse_repeated_field 14 parse_warning_parent_too_young x in
  let (_warning_title_dates_error, x) =
    Piqirun.parse_repeated_field 15 parse_warning_title_dates_error x in
  let (_warning_undefined_sex, x) =
    Piqirun.parse_repeated_field 16 parse_warning_undefined_sex x in
  let (_warning_young_for_marriage, x) =
    Piqirun.parse_repeated_field 17 parse_warning_young_for_marriage x in
  let (_warning_close_children, x) =
    Piqirun.parse_repeated_field 18 parse_warning_close_children x in
  let (_warning_parent_too_old, x) =
    Piqirun.parse_repeated_field 19 parse_warning_parent_too_old x in
  let (_warning_changed_order_of_marriages, x) =
    Piqirun.parse_repeated_field 20 parse_warning_changed_order_of_marriages
      x in
  let (_warning_big_age_between_spouses, x) =
    Piqirun.parse_repeated_field 21 parse_warning_big_age_between_spouses x in
  let (_warning_dead_old, x) =
    Piqirun.parse_repeated_field 22 parse_warning_dead_old x in
  let (_warning_old_individual, x) =
    Piqirun.parse_repeated_field 23 parse_warning_old_individual x in
  let (_warning_witness_date_after_death, x) =
    Piqirun.parse_repeated_field 24 parse_warning_witness_date_after_death x in
  let (_warning_witness_date_before_birth, x) =
    Piqirun.parse_repeated_field 25 parse_warning_witness_date_before_birth x
  in
    (Piqirun.check_unparsed_fields x;
     {
       ...
       Base_warnings.warning_bad_sex_of_married_person =
         _warning_bad_sex_of_married_person;
       ...
       Base_warnings.warning_parent_born_after_child =
         _warning_parent_born_after_child;
       ...
       Base_warnings.warning_changed_order_of_marriages =
         _warning_changed_order_of_marriages;
       Base_warnings.warning_big_age_between_spouses =
         _warning_big_age_between_spouses;
       ...
       Base_warnings.warning_witness_date_after_death =
         _warning_witness_date_after_death;
       Base_warnings.warning_witness_date_before_birth =
         _warning_witness_date_before_birth;
     })
and parse_filter_date x =
  ...
  let (_year, x) = Piqirun.parse_required_field 3 parse_protobuf_int32 x
  in
    (Piqirun.check_unparsed_fields x;
     {
...
and parse_filter_date_range x =
  let x = Piqirun.parse_record x in
  let (_date_begin, x) =
    Piqirun.parse_required_field 1 parse_filter_date x in
  let (_date_end, x) = Piqirun.parse_required_field 2 parse_filter_date x in
  let (_only_exact, x) =
    Piqirun.parse_required_field 3 parse_bool x ~default: "\b\000"
  in
    (Piqirun.check_unparsed_fields x;
     {
...
and parse_filters x =
  ...
  let (_nb_results, x) =
    Piqirun.parse_required_field 4 parse_bool x ~default: "\b\000" in
  let (_date_birth, x) =
    Piqirun.parse_optional_field 5 parse_filter_date_range x in
  let (_date_death, x) =
    Piqirun.parse_optional_field 6 parse_filter_date_range x
  in
    (Piqirun.check_unparsed_fields x;
     {
...
and parse_modification_status x =
  ...
  let (_base_warnings, x) =
    Piqirun.parse_required_field 2 parse_base_warnings x in
  let (_index, x) = Piqirun.parse_optional_field 3 parse_protobuf_int32 x
  in
    (Piqirun.check_unparsed_fields x;
     {
...
and parse_notification_birthday_params x =
  ...
  let (_person, x) =
    Piqirun.parse_required_field 1 parse_reference_person x in
  let (_params, x) =
    Piqirun.parse_required_field 2 parse_notif_birthday_params x in
  let (_month, x) = Piqirun.parse_optional_field 3 parse_protobuf_int32 x in
  let (_day, x) = Piqirun.parse_optional_field 4 parse_protobuf_int32 x
  in
    (Piqirun.check_unparsed_fields x;
     {
...
and parse_notification_birthday x =
  ...
  let (_has_proprio_birthday, x) =
    Piqirun.parse_required_field 2 parse_bool x in
  ...
  let (_firstname3, x) = Piqirun.parse_optional_field 5 parse_string x
  in
    (Piqirun.check_unparsed_fields x;
     {
...
and parse_person_start x =
  ...
  let (_birth_date_day, x) =
    Piqirun.parse_optional_field 4 parse_protobuf_int32 x in
  let (_birth_date_month, x) =
    Piqirun.parse_optional_field 5 parse_protobuf_int32 x in
  let (_birth_date_year, x) =
    Piqirun.parse_optional_field 6 parse_protobuf_int32 x
  in
    (Piqirun.check_unparsed_fields x;
     {
...
and parse_synchro_params x =
  let x = Piqirun.parse_record x in
  let (_export_directory, x) =
    Piqirun.parse_required_field 1 parse_string x in
  let (_timestamp, x) = Piqirun.parse_required_field 2 parse_string x
  in
    (Piqirun.check_unparsed_fields x;
     {
...
and parse_last_modifications x =
  ...
  let (_max_res, x) = Piqirun.parse_optional_field 2 parse_protobuf_int32 x
  in
    (Piqirun.check_unparsed_fields x;
     {
...
and parse_correspondance_family x =
  ...
  let (_children, x) = Piqirun.parse_repeated_field 3 parse_person x
  in
    (Piqirun.check_unparsed_fields x;
     {
...
and parse_correspondance x =
  ...
  let (_families, x) =
    Piqirun.parse_repeated_field 5 parse_correspondance_family x
  in
    (Piqirun.check_unparsed_fields x;
     {
...
and parse_correspondance_list x =
  let x = Piqirun.parse_record x in
  let (_correspondances, x) =
    Piqirun.parse_repeated_field 1 parse_correspondance x
  in
    (Piqirun.check_unparsed_fields x;
...
and gen__infos_base code x =
  let _nb_persons =
    Piqirun.gen_required_field 1 gen__protobuf_int64 x.Infos_base.nb_persons in
  let _nb_families =
    Piqirun.gen_required_field 2 gen__protobuf_int64 x.Infos_base.nb_families in
  let _sosa =
    Piqirun.gen_optional_field 3 gen__reference_person x.Infos_base.sosa in
  let _last_modified_person =
    Piqirun.gen_optional_field 4 gen__protobuf_int64
      x.Infos_base.last_modified_person
  in
    Piqirun.gen_record code
      [ _nb_persons; _nb_families; _sosa; _last_modified_person ]
and gen__reference_person code x =
  ...
  let _oc =
    Piqirun.gen_required_field 3 gen__protobuf_int32 x.Reference_person.oc
  in Piqirun.gen_record code [ _n; _p; _oc ]
and gen__list_reference_persons code x =
  let _list_ref_persons =
    Piqirun.gen_repeated_field 1 gen__reference_person
      x.List_reference_persons.list_ref_persons
  in Piqirun.gen_record code [ _list_ref_persons ]
and gen__relation_parent code x =
  let _father =
    Piqirun.gen_optional_field 1 gen__protobuf_int32 x.Relation_parent.father in
  let _mother =
    Piqirun.gen_optional_field 2 gen__protobuf_int32 x.Relation_parent.mother in
  let _source =
    Piqirun.gen_optional_field 3 gen__string x.Relation_parent.source in
  let _rpt_type =
    Piqirun.gen_required_field 4 gen__relation_parent_type
      x.Relation_parent.rpt_type
  in Piqirun.gen_record code [ _father; _mother; _source; _rpt_type ]
and gen__title code x =
  let _title_type =
    Piqirun.gen_required_field 1 gen__title_type x.Title.title_type in
  ...
  let _date_begin =
    Piqirun.gen_optional_field 5 gen__string x.Title.date_begin in
  let _date_end =
    Piqirun.gen_optional_field 6 gen__string x.Title.date_end in
  let _nth = Piqirun.gen_optional_field 7 gen__protobuf_int32 x.Title.nth
  in
    Piqirun.gen_record code
      [ _title_type; _name; _title; _fief; _date_begin; _date_end; _nth ]
and gen__spouse code x =
  ...
  let _lastname =
    Piqirun.gen_required_field 6 gen__string x.Spouse.lastname in
  let _firstname =
    Piqirun.gen_required_field 7 gen__string x.Spouse.firstname in
  let _public_name =
    Piqirun.gen_optional_field 8 gen__string x.Spouse.public_name in
  let _image = Piqirun.gen_required_field 9 gen__string x.Spouse.image in
  let _birth_date =
    Piqirun.gen_required_field 10 gen__string x.Spouse.birth_date in
  let _birth_place =
    Piqirun.gen_required_field 11 gen__string x.Spouse.birth_place in
  let _baptism_date =
    Piqirun.gen_required_field 12 gen__string x.Spouse.baptism_date in
  let _baptism_place =
    Piqirun.gen_required_field 13 gen__string x.Spouse.baptism_place in
  let _death_date =
    Piqirun.gen_required_field 14 gen__string x.Spouse.death_date in
  let _death_place =
    Piqirun.gen_required_field 15 gen__string x.Spouse.death_place in
  let _death_type =
    Piqirun.gen_required_field 16 gen__death_type x.Spouse.death_type in
  let _burial_date =
    Piqirun.gen_required_field 17 gen__string x.Spouse.burial_date in
  let _burial_place =
    Piqirun.gen_required_field 18 gen__string x.Spouse.burial_place in
  let _marriage_date =
    Piqirun.gen_required_field 19 gen__string x.Spouse.marriage_date in
  let _marriage_place =
    Piqirun.gen_required_field 20 gen__string x.Spouse.marriage_place in
  let _divorce_type =
    Piqirun.gen_required_field 21 gen__divorce_type x.Spouse.divorce_type in
  let _visible_for_visitors =
    Piqirun.gen_required_field 22 gen__bool x.Spouse.visible_for_visitors
  in
    Piqirun.gen_record code
      [ _sosa; _n; _p; _oc; _sex; _lastname; _firstname; _public_name;
        _image; _birth_date; _birth_place; _baptism_date; _baptism_place;
        _death_date; _death_place; _death_type; _burial_date; _burial_place;
        _marriage_date; _marriage_place; _divorce_type; _visible_for_visitors ]
and gen__person code x =
  ...
  let _lastname =
    Piqirun.gen_required_field 6 gen__string x.Person.lastname in
  let _firstname =
    Piqirun.gen_required_field 7 gen__string x.Person.firstname in
  let _public_name =
  ...
  let _birth_date =
    Piqirun.gen_required_field 10 gen__string x.Person.birth_date in
  let _birth_place =
    Piqirun.gen_required_field 11 gen__string x.Person.birth_place in
  let _baptism_date =
    Piqirun.gen_required_field 12 gen__string x.Person.baptism_date in
  let _baptism_place =
    Piqirun.gen_required_field 13 gen__string x.Person.baptism_place in
  let _death_date =
    Piqirun.gen_required_field 14 gen__string x.Person.death_date in
  let _death_place =
    Piqirun.gen_required_field 15 gen__string x.Person.death_place in
  let _death_type =
    Piqirun.gen_required_field 16 gen__death_type x.Person.death_type in
  let _burial_date =
    Piqirun.gen_required_field 17 gen__string x.Person.burial_date in
  let _burial_place =
    Piqirun.gen_required_field 18 gen__string x.Person.burial_place in
  let _spouses =
    Piqirun.gen_repeated_field 19 gen__spouse x.Person.spouses in
  ...
  let _visible_for_visitors =
    Piqirun.gen_required_field 22 gen__bool x.Person.visible_for_visitors
  in
    Piqirun.gen_record code
      [ _sosa; _n; _p; _oc; _sex; _lastname; _firstname; _public_name;
        _image; _birth_date; _birth_place; _baptism_date; _baptism_place;
        _death_date; _death_place; _death_type; _burial_date; _burial_place;
        _spouses; _ascend; _descend; _visible_for_visitors ]
and gen__full_person code x =
  ...
  let _oc =
    Piqirun.gen_required_field 4 gen__protobuf_int32 x.Full_person.oc in
  let _index =
    Piqirun.gen_required_field 5 gen__protobuf_int32 x.Full_person.index in
  let _sex = Piqirun.gen_required_field 6 gen__sex x.Full_person.sex in
  let _lastname =
    Piqirun.gen_required_field 7 gen__string x.Full_person.lastname in
  let _firstname =
    Piqirun.gen_required_field 8 gen__string x.Full_person.firstname in
  let _public_name =
    Piqirun.gen_optional_field 9 gen__string x.Full_person.public_name in
  let _aliases =
    Piqirun.gen_repeated_field 10 gen__string x.Full_person.aliases in
  let _qualifiers =
    Piqirun.gen_repeated_field 11 gen__string x.Full_person.qualifiers in
  let _firstname_aliases =
    Piqirun.gen_repeated_field 12 gen__string x.Full_person.firstname_aliases in
  let _surname_aliases =
    Piqirun.gen_repeated_field 13 gen__string x.Full_person.surname_aliases in
  let _image =
    Piqirun.gen_optional_field 15 gen__string x.Full_person.image in
  let _birth_date =
    Piqirun.gen_optional_field 16 gen__string x.Full_person.birth_date in
  let _birth_place =
    Piqirun.gen_optional_field 17 gen__string x.Full_person.birth_place in
  let _birth_src =
    Piqirun.gen_optional_field 18 gen__string x.Full_person.birth_src in
  let _baptism_date =
    Piqirun.gen_optional_field 19 gen__string x.Full_person.baptism_date in
  let _baptism_place =
    Piqirun.gen_optional_field 20 gen__string x.Full_person.baptism_place in
  let _baptism_src =
    Piqirun.gen_optional_field 21 gen__string x.Full_person.baptism_src in
  let _death_date =
    Piqirun.gen_optional_field 22 gen__string x.Full_person.death_date in
  let _death_place =
    Piqirun.gen_optional_field 23 gen__string x.Full_person.death_place in
  let _death_src =
    Piqirun.gen_optional_field 24 gen__string x.Full_person.death_src in
  let _death_type =
    Piqirun.gen_required_field 25 gen__death_type x.Full_person.death_type in
  let _burial_date =
    Piqirun.gen_optional_field 26 gen__string x.Full_person.burial_date in
  let _burial_place =
    Piqirun.gen_optional_field 27 gen__string x.Full_person.burial_place in
  let _burial_src =
    Piqirun.gen_optional_field 28 gen__string x.Full_person.burial_src in
  let _occupation =
    Piqirun.gen_optional_field 30 gen__string x.Full_person.occupation in
  let _psources =
    Piqirun.gen_optional_field 31 gen__string x.Full_person.psources in
  let _titles =
    Piqirun.gen_repeated_field 32 gen__title x.Full_person.titles in
  let _related =
    Piqirun.gen_repeated_field 33 gen__internal_int32 x.Full_person.related in
  let _rparents =
    Piqirun.gen_repeated_field 34 gen__relation_parent x.Full_person.rparents in
  let _visible_for_visitors =
    Piqirun.gen_required_field 35 gen__bool
      x.Full_person.visible_for_visitors in
  let _parents =
    Piqirun.gen_optional_field 36 gen__protobuf_int32 x.Full_person.parents in
  let _families =
    Piqirun.gen_repeated_field 37 gen__internal_int32 x.Full_person.families
  in
    Piqirun.gen_record code
      [ _sosa; _n; _p; _oc; _index; _sex; _lastname; _firstname;
        _public_name; _aliases; _qualifiers; _firstname_aliases;
        _surname_aliases; _image; _birth_date; _birth_place; _birth_src;
        _baptism_date; _baptism_place; _baptism_src; _death_date;
        _death_place; _death_src; _death_type; _burial_date; _burial_place;
        _burial_src; _occupation; _psources; _titles; _related; _rparents;
        _visible_for_visitors; _parents; _families ]
and gen__full_family code x =
  let _fsources =
    Piqirun.gen_optional_field 1 gen__string x.Full_family.fsources in
  let _marriage_date =
    Piqirun.gen_optional_field 2 gen__string x.Full_family.marriage_date in
  let _marriage_place =
    Piqirun.gen_optional_field 3 gen__string x.Full_family.marriage_place in
  let _marriage_src =
    Piqirun.gen_optional_field 4 gen__string x.Full_family.marriage_src in
  let _marriage_type =
    Piqirun.gen_required_field 5 gen__marriage_type
      x.Full_family.marriage_type in
  let _divorce_type =
    Piqirun.gen_required_field 6 gen__divorce_type x.Full_family.divorce_type in
  let _divorce_date =
    Piqirun.gen_optional_field 7 gen__string x.Full_family.divorce_date in
  let _witnesses =
    Piqirun.gen_repeated_field 8 gen__internal_int32 x.Full_family.witnesses in
  let _father =
    Piqirun.gen_required_field 9 gen__protobuf_int32 x.Full_family.father in
  let _mother =
    Piqirun.gen_required_field 10 gen__protobuf_int32 x.Full_family.mother in
  let _children =
    Piqirun.gen_repeated_field 11 gen__internal_int32 x.Full_family.children in
  let _index =
    Piqirun.gen_required_field 12 gen__protobuf_int32 x.Full_family.index
  in
    Piqirun.gen_record code
      [ _fsources; _marriage_date; _marriage_place; _marriage_src;
        _marriage_type; _divorce_type; _divorce_date; _witnesses; _father;
        _mother; _children; _index ]
and gen__internal_int32 code x =
  let _value =
    Piqirun.gen_required_field 1 gen__protobuf_int32 x.Internal_int32.value
  in Piqirun.gen_record code [ _value ]
and gen__list_persons code x =
  let _list_persons =
    Piqirun.gen_repeated_field 1 gen__person x.List_persons.list_persons
  in Piqirun.gen_record code [ _list_persons ]
and gen__list_full_persons code x =
  let _persons =
    Piqirun.gen_repeated_field 1 gen__full_person x.List_full_persons.persons
  in Piqirun.gen_record code [ _persons ]
and gen__list_full_families code x =
  let _families =
    Piqirun.gen_repeated_field 1 gen__full_family
      x.List_full_families.families
  in Piqirun.gen_record code [ _families ]
and gen__search_params code x =
  let _search_type =
    Piqirun.gen_required_field 1 gen__search_type x.Search_params.search_type in
  let _lastname =
    Piqirun.gen_optional_field 2 gen__string x.Search_params.lastname in
  let _firstname =
    Piqirun.gen_optional_field 3 gen__string x.Search_params.firstname in
  let _only_sosa =
    Piqirun.gen_required_field 4 gen__bool x.Search_params.only_sosa in
  let _only_recent =
    Piqirun.gen_required_field 5 gen__bool x.Search_params.only_recent in
  let _maiden_name =
    Piqirun.gen_required_field 6 gen__bool x.Search_params.maiden_name
  in
    Piqirun.gen_record code
      [ _search_type; _lastname; _firstname; _only_sosa; _only_recent;
        _maiden_name ]
and gen__image code x =
  let _person = Piqirun.gen_required_field 1 gen__person x.Image.person in
  let _img = Piqirun.gen_required_field 2 gen__string x.Image.img
  in Piqirun.gen_record code [ _person; _img ]
and gen__full_image code x =
  let _person =
    Piqirun.gen_required_field 1 gen__full_person x.Full_image.person in
  let _img = Piqirun.gen_required_field 2 gen__string x.Full_image.img
  in Piqirun.gen_record code [ _person; _img ]
and gen__list_images code x =
  let _list_images =
    Piqirun.gen_repeated_field 1 gen__image x.List_images.list_images
  in Piqirun.gen_record code [ _list_images ]
and gen__list_full_images code x =
  let _images =
    Piqirun.gen_repeated_field 1 gen__full_image x.List_full_images.images
  in Piqirun.gen_record code [ _images ]
and gen__pers_img code x =
  let _person =
    Piqirun.gen_required_field 1 gen__reference_person x.Pers_img.person in
  let _img = Piqirun.gen_required_field 2 gen__string x.Pers_img.img
  in Piqirun.gen_record code [ _person; _img ]
and gen__list_pers_img code x =
  let _list_pers_img =
    Piqirun.gen_repeated_field 1 gen__pers_img x.List_pers_img.list_pers_img
  in Piqirun.gen_record code [ _list_pers_img ]
and gen__index code x =
  let _index = Piqirun.gen_required_field 1 gen__protobuf_int32 x.Index.index
  in Piqirun.gen_record code [ _index ]
and gen__image_address code x =
  let _img = Piqirun.gen_required_field 1 gen__string x.Image_address.img
  in Piqirun.gen_record code [ _img ]
and gen__close_persons_params code x =
  let _person =
    Piqirun.gen_required_field 1 gen__reference_person
      x.Close_persons_params.person in
  let _nb_gen_asc =
    Piqirun.gen_optional_field 2 gen__protobuf_int32
      x.Close_persons_params.nb_gen_asc in
  let _nb_gen_desc =
    Piqirun.gen_optional_field 3 gen__protobuf_int32
      x.Close_persons_params.nb_gen_desc in
  let _spouse_ascend =
    Piqirun.gen_required_field 4 gen__bool
      x.Close_persons_params.spouse_ascend in
  let _only_recent =
    Piqirun.gen_required_field 5 gen__bool x.Close_persons_params.only_recent
  in
    Piqirun.gen_record code
      [ _person; _nb_gen_asc; _nb_gen_desc; _spouse_ascend; _only_recent ]
and gen__person_relation code x =
  let _person =
    Piqirun.gen_required_field 1 gen__person x.Person_relation.person in
  let _relation =
    Piqirun.gen_required_field 2 gen__relation_type
      x.Person_relation.relation
  in Piqirun.gen_record code [ _person; _relation ]
and gen__full_person_relation code x =
  let _person =
    Piqirun.gen_required_field 1 gen__full_person
      x.Full_person_relation.person in
  let _relation =
    Piqirun.gen_required_field 2 gen__relation_type
      x.Full_person_relation.relation
  in Piqirun.gen_record code [ _person; _relation ]
and gen__list_person_relation code x =
  let _person_relations =
    Piqirun.gen_repeated_field 1 gen__person_relation
      x.List_person_relation.person_relations
  in Piqirun.gen_record code [ _person_relations ]
and gen__list_full_person_relation code x =
  let _person_relations =
    Piqirun.gen_repeated_field 1 gen__full_person_relation
      x.List_full_person_relation.person_relations
  in Piqirun.gen_record code [ _person_relations ]
and gen__anniversary_params code x =
  let _month =
    Piqirun.gen_optional_field 1 gen__protobuf_int32
      x.Anniversary_params.month
  in Piqirun.gen_record code [ _month ]
and gen__graph_params code x =
  let _generation =
    Piqirun.gen_optional_field 1 gen__protobuf_int32
      x.Graph_params.generation in
  let _person =
    Piqirun.gen_required_field 2 gen__reference_person x.Graph_params.person
  in Piqirun.gen_record code [ _generation; _person ]
and gen__graph_rel_params code x =
  let _person1 =
    Piqirun.gen_required_field 1 gen__reference_person
      x.Graph_rel_params.person1 in
  let _person2 =
    Piqirun.gen_required_field 2 gen__reference_person
      x.Graph_rel_params.person2
  in Piqirun.gen_record code [ _person1; _person2 ]
and gen__cpl_rel_params code x =
  let _person1 =
    Piqirun.gen_required_field 1 gen__reference_person
      x.Cpl_rel_params.person1 in
  let _person2 =
    Piqirun.gen_required_field 2 gen__reference_person
      x.Cpl_rel_params.person2
  in Piqirun.gen_record code [ _person1; _person2 ]
and gen__node code x =
  let _id = Piqirun.gen_required_field 1 gen__protobuf_int64 x.Node.id in
  let _person = Piqirun.gen_required_field 2 gen__person x.Node.person
  in Piqirun.gen_record code [ _id; _person ]
and gen__full_node code x =
  let _id =
    Piqirun.gen_required_field 1 gen__protobuf_int64 x.Full_node.id in
  let _person =
    Piqirun.gen_required_field 2 gen__full_person x.Full_node.person
  in Piqirun.gen_record code [ _id; _person ]
...
and gen__graph code x =
  ...
  let _edges = Piqirun.gen_repeated_field 2 gen__edge x.Graph.edges
  in Piqirun.gen_record code [ _nodes; _edges ]
and gen__full_graph code x =
  let _nodes =
    Piqirun.gen_repeated_field 1 gen__full_node x.Full_graph.nodes in
  let _edges = Piqirun.gen_repeated_field 2 gen__edge x.Full_graph.edges in
  let _families =
    Piqirun.gen_repeated_field 3 gen__full_family x.Full_graph.families
  in Piqirun.gen_record code [ _nodes; _edges; _families ]
and gen__all_persons_params code x =
  let _from =
    Piqirun.gen_optional_field 1 gen__protobuf_int32
      x.All_persons_params.from in
  let _limit =
    Piqirun.gen_optional_field 2 gen__protobuf_int32
      x.All_persons_params.limit
  in Piqirun.gen_record code [ _from; _limit ]
and gen__all_families_params code x =
  let _from =
    Piqirun.gen_optional_field 1 gen__protobuf_int32
      x.All_families_params.from in
  let _limit =
    Piqirun.gen_optional_field 2 gen__protobuf_int32
      x.All_families_params.limit
  in Piqirun.gen_record code [ _from; _limit ]
and gen__warning_already_defined code x =
  let _person =
    Piqirun.gen_required_field 1 gen__full_person
      x.Warning_already_defined.person
  in Piqirun.gen_record code [ _person ]
and gen__warning_own_ancestor code x =
  let _person =
    Piqirun.gen_required_field 1 gen__full_person
      x.Warning_own_ancestor.person
  in Piqirun.gen_record code [ _person ]
and gen__warning_bad_sex_of_married_person code x =
  let _person =
    Piqirun.gen_required_field 1 gen__full_person
      x.Warning_bad_sex_of_married_person.person
  in Piqirun.gen_record code [ _person ]
and gen__warning_birth_after_death code x =
  let _person =
    Piqirun.gen_required_field 1 gen__full_person
      x.Warning_birth_after_death.person
  in Piqirun.gen_record code [ _person ]
and gen__warning_incoherent_sex code x =
  let _person =
    Piqirun.gen_required_field 1 gen__full_person
      x.Warning_incoherent_sex.person
  in Piqirun.gen_record code [ _person ]
and gen__warning_changed_order_of_children code x =
  let _father =
    Piqirun.gen_required_field 1 gen__full_person
      x.Warning_changed_order_of_children.father in
  let _mother =
    Piqirun.gen_required_field 2 gen__full_person
      x.Warning_changed_order_of_children.mother
  in Piqirun.gen_record code [ _father; _mother ]
and gen__warning_changed_order_of_marriages code x =
  let _person =
    Piqirun.gen_required_field 1 gen__full_person
      x.Warning_changed_order_of_marriages.person
  in Piqirun.gen_record code [ _person ]
and gen__warning_children_not_in_order code x =
  let _father =
    Piqirun.gen_required_field 1 gen__full_person
      x.Warning_children_not_in_order.father in
  let _mother =
    Piqirun.gen_required_field 2 gen__full_person
      x.Warning_children_not_in_order.mother
  in Piqirun.gen_record code [ _father; _mother ]
and gen__warning_dead_too_early_to_be_father code x =
  let _son =
    Piqirun.gen_required_field 1 gen__full_person
      x.Warning_dead_too_early_to_be_father.son in
  let _father =
    Piqirun.gen_required_field 2 gen__full_person
      x.Warning_dead_too_early_to_be_father.father
  in Piqirun.gen_record code [ _son; _father ]
and gen__warning_incoherent_ancestor_date code x =
  let _person =
    Piqirun.gen_required_field 1 gen__full_person
      x.Warning_incoherent_ancestor_date.person in
  let _ancestor =
    Piqirun.gen_required_field 2 gen__full_person
      x.Warning_incoherent_ancestor_date.ancestor
  in Piqirun.gen_record code [ _person; _ancestor ]
and gen__warning_marriage_date_after_death code x =
  let _person =
    Piqirun.gen_required_field 1 gen__full_person
      x.Warning_marriage_date_after_death.person
  in Piqirun.gen_record code [ _person ]
and gen__warning_marriage_date_before_birth code x =
  let _person =
    Piqirun.gen_required_field 1 gen__full_person
      x.Warning_marriage_date_before_birth.person
  in Piqirun.gen_record code [ _person ]
and gen__warning_mother_dead_before_child_birth code x =
  let _mother =
    Piqirun.gen_required_field 1 gen__full_person
      x.Warning_mother_dead_before_child_birth.mother in
  let _child =
    Piqirun.gen_required_field 2 gen__full_person
      x.Warning_mother_dead_before_child_birth.child
  in Piqirun.gen_record code [ _mother; _child ]
and gen__warning_parent_born_after_child code x =
  let _parent =
    Piqirun.gen_required_field 1 gen__full_person
      x.Warning_parent_born_after_child.parent in
  let _child =
    Piqirun.gen_required_field 2 gen__full_person
      x.Warning_parent_born_after_child.child
  in Piqirun.gen_record code [ _parent; _child ]
and gen__warning_parent_too_young code x =
  let _parent =
    Piqirun.gen_required_field 1 gen__full_person
      x.Warning_parent_too_young.parent in
  let _date =
    Piqirun.gen_required_field 2 gen__string x.Warning_parent_too_young.date
  in Piqirun.gen_record code [ _parent; _date ]
and gen__warning_title_dates_error code x =
  let _person =
    Piqirun.gen_required_field 1 gen__full_person
      x.Warning_title_dates_error.person
  in Piqirun.gen_record code [ _person ]
and gen__warning_undefined_sex code x =
  let _person =
    Piqirun.gen_required_field 1 gen__full_person
      x.Warning_undefined_sex.person
  in Piqirun.gen_record code [ _person ]
and gen__warning_young_for_marriage code x =
  let _person =
    Piqirun.gen_required_field 1 gen__full_person
      x.Warning_young_for_marriage.person in
  let _date =
    Piqirun.gen_required_field 2 gen__string
      x.Warning_young_for_marriage.date
  in Piqirun.gen_record code [ _person; _date ]
and gen__warning_parent_too_old code x =
  let _parent =
    Piqirun.gen_required_field 1 gen__full_person
      x.Warning_parent_too_old.parent in
  let _date =
    Piqirun.gen_required_field 2 gen__string x.Warning_parent_too_old.date
  in Piqirun.gen_record code [ _parent; _date ]
and gen__warning_close_children code x =
  let _father =
    Piqirun.gen_required_field 1 gen__full_person
      x.Warning_close_children.father in
  let _mother =
    Piqirun.gen_required_field 2 gen__full_person
      x.Warning_close_children.mother in
  let _child1 =
    Piqirun.gen_required_field 3 gen__full_person
      x.Warning_close_children.child1 in
  let _child2 =
    Piqirun.gen_required_field 4 gen__full_person
      x.Warning_close_children.child2
  in Piqirun.gen_record code [ _father; _mother; _child1; _child2 ]
and gen__warning_big_age_between_spouses code x =
  let _father =
    Piqirun.gen_required_field 1 gen__full_person
      x.Warning_big_age_between_spouses.father in
  let _mother =
    Piqirun.gen_required_field 2 gen__full_person
      x.Warning_big_age_between_spouses.mother in
  let _date =
    Piqirun.gen_required_field 3 gen__string
      x.Warning_big_age_between_spouses.date
  in Piqirun.gen_record code [ _father; _mother; _date ]
and gen__warning_dead_old code x =
  let _person =
    Piqirun.gen_required_field 1 gen__full_person x.Warning_dead_old.person in
  let _date =
    Piqirun.gen_required_field 3 gen__string x.Warning_dead_old.date
  in Piqirun.gen_record code [ _person; _date ]
and gen__warning_old_individual code x =
  let _person =
    Piqirun.gen_required_field 1 gen__full_person
      x.Warning_old_individual.person in
  let _date =
    Piqirun.gen_required_field 3 gen__string x.Warning_old_individual.date
  in Piqirun.gen_record code [ _person; _date ]
and gen__warning_witness_date_after_death code x =
  let _person =
    Piqirun.gen_required_field 1 gen__full_person
      x.Warning_witness_date_after_death.person
  in Piqirun.gen_record code [ _person ]
and gen__warning_witness_date_before_birth code x =
  let _person =
    Piqirun.gen_required_field 1 gen__full_person
      x.Warning_witness_date_before_birth.person
  in Piqirun.gen_record code [ _person ]
and gen__warning_changed_order_of_family_events code x =
  let _father =
    Piqirun.gen_required_field 1 gen__full_person
      x.Warning_changed_order_of_family_events.father in
  let _mother =
    Piqirun.gen_required_field 2 gen__full_person
      x.Warning_changed_order_of_family_events.mother
  in Piqirun.gen_record code [ _father; _mother ]
and gen__warning_changed_order_of_person_events code x =
  let _person =
    Piqirun.gen_required_field 1 gen__full_person
      x.Warning_changed_order_of_person_events.person
  in Piqirun.gen_record code [ _person ]
and gen__warning_fevent_order code x =
  let _person =
    Piqirun.gen_required_field 1 gen__full_person
      x.Warning_fevent_order.person in
  let _event1 =
    Piqirun.gen_required_field 2 gen__string x.Warning_fevent_order.event1 in
  let _event2 =
    Piqirun.gen_required_field 3 gen__string x.Warning_fevent_order.event2
  in Piqirun.gen_record code [ _person; _event1; _event2 ]
and gen__warning_fwitness_event_after_death code x =
  let _person =
    Piqirun.gen_required_field 1 gen__full_person
      x.Warning_fwitness_event_after_death.person in
  let _event =
    Piqirun.gen_required_field 2 gen__string
      x.Warning_fwitness_event_after_death.event
  in Piqirun.gen_record code [ _person; _event ]
and gen__warning_fwitness_event_before_birth code x =
  let _person =
    Piqirun.gen_required_field 1 gen__full_person
      x.Warning_fwitness_event_before_birth.person in
  let _event =
    Piqirun.gen_required_field 2 gen__string
      x.Warning_fwitness_event_before_birth.event
  in Piqirun.gen_record code [ _person; _event ]
and gen__warning_pevent_order code x =
  let _person =
    Piqirun.gen_required_field 1 gen__full_person
      x.Warning_pevent_order.person in
  let _event1 =
    Piqirun.gen_required_field 2 gen__string x.Warning_pevent_order.event1 in
  let _event2 =
    Piqirun.gen_required_field 3 gen__string x.Warning_pevent_order.event2
  in Piqirun.gen_record code [ _person; _event1; _event2 ]
and gen__warning_pwitness_event_after_death code x =
  let _person =
    Piqirun.gen_required_field 1 gen__full_person
      x.Warning_pwitness_event_after_death.person in
  let _event =
    Piqirun.gen_required_field 2 gen__string
      x.Warning_pwitness_event_after_death.event
  in Piqirun.gen_record code [ _person; _event ]
and gen__warning_pwitness_event_before_birth code x =
  let _person =
    Piqirun.gen_required_field 1 gen__full_person
      x.Warning_pwitness_event_before_birth.person in
  let _event =
    Piqirun.gen_required_field 2 gen__string
      x.Warning_pwitness_event_before_birth.event
  in Piqirun.gen_record code [ _person; _event ]
and gen__base_warnings code x =
  let _warning_already_defined =
    Piqirun.gen_repeated_field 1 gen__warning_already_defined
      x.Base_warnings.warning_already_defined in
  let _warning_own_ancestor =
    Piqirun.gen_repeated_field 2 gen__warning_own_ancestor
      x.Base_warnings.warning_own_ancestor in
  let _warning_bad_sex_of_married_person =
    Piqirun.gen_repeated_field 3 gen__warning_bad_sex_of_married_person
      x.Base_warnings.warning_bad_sex_of_married_person in
  let _warning_birth_after_death =
    Piqirun.gen_repeated_field 4 gen__warning_birth_after_death
      x.Base_warnings.warning_birth_after_death in
  let _warning_incoherent_sex =
    Piqirun.gen_repeated_field 5 gen__warning_incoherent_sex
      x.Base_warnings.warning_incoherent_sex in
  let _warning_changed_order_of_children =
    Piqirun.gen_repeated_field 6 gen__warning_changed_order_of_children
      x.Base_warnings.warning_changed_order_of_children in
  let _warning_children_not_in_order =
    Piqirun.gen_repeated_field 7 gen__warning_children_not_in_order
      x.Base_warnings.warning_children_not_in_order in
  let _warning_dead_too_early_to_be_father =
    Piqirun.gen_repeated_field 8 gen__warning_dead_too_early_to_be_father
      x.Base_warnings.warning_dead_too_early_to_be_father in
  let _warning_incoherent_ancestor_date =
    Piqirun.gen_repeated_field 9 gen__warning_incoherent_ancestor_date
      x.Base_warnings.warning_incoherent_ancestor_date in
  let _warning_marriage_date_after_death =
    Piqirun.gen_repeated_field 10 gen__warning_marriage_date_after_death
      x.Base_warnings.warning_marriage_date_after_death in
  let _warning_marriage_date_before_birth =
    Piqirun.gen_repeated_field 11 gen__warning_marriage_date_before_birth
      x.Base_warnings.warning_marriage_date_before_birth in
  let _warning_mother_dead_before_child_birth =
    Piqirun.gen_repeated_field 12 gen__warning_mother_dead_before_child_birth
      x.Base_warnings.warning_mother_dead_before_child_birth in
  let _warning_parent_born_after_child =
    Piqirun.gen_repeated_field 13 gen__warning_parent_born_after_child
      x.Base_warnings.warning_parent_born_after_child in
  let _warning_parent_too_young =
    Piqirun.gen_repeated_field 14 gen__warning_parent_too_young
      x.Base_warnings.warning_parent_too_young in
  let _warning_title_dates_error =
    Piqirun.gen_repeated_field 15 gen__warning_title_dates_error
      x.Base_warnings.warning_title_dates_error in
  let _warning_undefined_sex =
    Piqirun.gen_repeated_field 16 gen__warning_undefined_sex
      x.Base_warnings.warning_undefined_sex in
  let _warning_young_for_marriage =
    Piqirun.gen_repeated_field 17 gen__warning_young_for_marriage
      x.Base_warnings.warning_young_for_marriage in
  let _warning_close_children =
    Piqirun.gen_repeated_field 18 gen__warning_close_children
      x.Base_warnings.warning_close_children in
  let _warning_parent_too_old =
    Piqirun.gen_repeated_field 19 gen__warning_parent_too_old
      x.Base_warnings.warning_parent_too_old in
  let _warning_changed_order_of_marriages =
    Piqirun.gen_repeated_field 20 gen__warning_changed_order_of_marriages
      x.Base_warnings.warning_changed_order_of_marriages in
  let _warning_big_age_between_spouses =
    Piqirun.gen_repeated_field 21 gen__warning_big_age_between_spouses
      x.Base_warnings.warning_big_age_between_spouses in
  let _warning_dead_old =
    Piqirun.gen_repeated_field 22 gen__warning_dead_old
      x.Base_warnings.warning_dead_old in
  let _warning_old_individual =
    Piqirun.gen_repeated_field 23 gen__warning_old_individual
      x.Base_warnings.warning_old_individual in
  let _warning_witness_date_after_death =
    Piqirun.gen_repeated_field 24 gen__warning_witness_date_after_death
      x.Base_warnings.warning_witness_date_after_death in
  let _warning_witness_date_before_birth =
    Piqirun.gen_repeated_field 25 gen__warning_witness_date_before_birth
      x.Base_warnings.warning_witness_date_before_birth
  in
    Piqirun.gen_record code
      [ _warning_already_defined; _warning_own_ancestor;
        _warning_bad_sex_of_married_person; _warning_birth_after_death;
        _warning_incoherent_sex; _warning_changed_order_of_children;
        _warning_children_not_in_order; _warning_dead_too_early_to_be_father;
        _warning_incoherent_ancestor_date;
        _warning_marriage_date_after_death;
        _warning_marriage_date_before_birth;
        _warning_mother_dead_before_child_birth;
        _warning_parent_born_after_child; _warning_parent_too_young;
        _warning_title_dates_error; _warning_undefined_sex;
        _warning_young_for_marriage; _warning_close_children;
        _warning_parent_too_old; _warning_changed_order_of_marriages;
        _warning_big_age_between_spouses; _warning_dead_old;
        _warning_old_individual; _warning_witness_date_after_death;
        _warning_witness_date_before_birth ]
and gen__filter_date code x =
  let _day =
    Piqirun.gen_required_field 1 gen__protobuf_int32 x.Filter_date.day in
  let _month =
    Piqirun.gen_required_field 2 gen__protobuf_int32 x.Filter_date.month in
  let _year =
    Piqirun.gen_required_field 3 gen__protobuf_int32 x.Filter_date.year
  in Piqirun.gen_record code [ _day; _month; _year ]
and gen__filter_date_range code x =
  let _date_begin =
    Piqirun.gen_required_field 1 gen__filter_date
      x.Filter_date_range.date_begin in
  let _date_end =
    Piqirun.gen_required_field 2 gen__filter_date
      x.Filter_date_range.date_end in
  let _only_exact =
    Piqirun.gen_required_field 3 gen__bool x.Filter_date_range.only_exact
  in Piqirun.gen_record code [ _date_begin; _date_end; _only_exact ]
and gen__filters code x =
  let _only_sosa =
    Piqirun.gen_required_field 1 gen__bool x.Filters.only_sosa in
  let _only_recent =
    Piqirun.gen_required_field 2 gen__bool x.Filters.only_recent in
  let _sex = Piqirun.gen_optional_field 3 gen__sex x.Filters.sex in
  let _nb_results =
    Piqirun.gen_required_field 4 gen__bool x.Filters.nb_results in
  let _date_birth =
    Piqirun.gen_optional_field 5 gen__filter_date_range x.Filters.date_birth in
  let _date_death =
    Piqirun.gen_optional_field 6 gen__filter_date_range x.Filters.date_death
  in
    Piqirun.gen_record code
      [ _only_sosa; _only_recent; _sex; _nb_results; _date_birth; _date_death ]
and gen__modification_status code x =
  let _status =
    Piqirun.gen_required_field 1 gen__bool x.Modification_status.status in
  let _base_warnings =
    Piqirun.gen_required_field 2 gen__base_warnings
      x.Modification_status.base_warnings in
  let _index =
    Piqirun.gen_optional_field 3 gen__protobuf_int32
      x.Modification_status.index
  in Piqirun.gen_record code [ _status; _base_warnings; _index ]
and gen__notification_birthday_params code x =
  let _person =
    Piqirun.gen_required_field 1 gen__reference_person
      x.Notification_birthday_params.person in
  let _params =
    Piqirun.gen_required_field 2 gen__notif_birthday_params
      x.Notification_birthday_params.params in
  let _month =
    Piqirun.gen_optional_field 3 gen__protobuf_int32
      x.Notification_birthday_params.month in
  let _day =
    Piqirun.gen_optional_field 4 gen__protobuf_int32
      x.Notification_birthday_params.day
  in Piqirun.gen_record code [ _person; _params; _month; _day ]
and gen__notification_birthday code x =
  let _number =
    Piqirun.gen_required_field 1 gen__protobuf_int32
      x.Notification_birthday.number in
  let _has_proprio_birthday =
    Piqirun.gen_required_field 2 gen__bool
      x.Notification_birthday.has_proprio_birthday in
  let _firstname1 =
    Piqirun.gen_optional_field 3 gen__string
      x.Notification_birthday.firstname1 in
  let _firstname2 =
    Piqirun.gen_optional_field 4 gen__string
      x.Notification_birthday.firstname2 in
  let _firstname3 =
    Piqirun.gen_optional_field 5 gen__string
      x.Notification_birthday.firstname3
  in
    Piqirun.gen_record code
      [ _number; _has_proprio_birthday; _firstname1; _firstname2; _firstname3 ]
and gen__person_start code x =
  let _lastname =
    Piqirun.gen_required_field 1 gen__string x.Person_start.lastname in
  let _firstname =
    Piqirun.gen_required_field 2 gen__string x.Person_start.firstname in
  let _sex = Piqirun.gen_required_field 3 gen__sex x.Person_start.sex in
  let _birth_date_day =
    Piqirun.gen_optional_field 4 gen__protobuf_int32
      x.Person_start.birth_date_day in
  let _birth_date_month =
    Piqirun.gen_optional_field 5 gen__protobuf_int32
      x.Person_start.birth_date_month in
  let _birth_date_year =
    Piqirun.gen_optional_field 6 gen__protobuf_int32
      x.Person_start.birth_date_year
  in
    Piqirun.gen_record code
      [ _lastname; _firstname; _sex; _birth_date_day; _birth_date_month;
        _birth_date_year ]
and gen__synchro_params code x =
  let _export_directory =
    Piqirun.gen_required_field 1 gen__string
      x.Synchro_params.export_directory in
  let _timestamp =
    Piqirun.gen_required_field 2 gen__string x.Synchro_params.timestamp
  in Piqirun.gen_record code [ _export_directory; _timestamp ]
and gen__last_modifications code x =
  let _wizard =
    Piqirun.gen_optional_field 1 gen__string x.Last_modifications.wizard in
  let _max_res =
    Piqirun.gen_optional_field 2 gen__protobuf_int32
      x.Last_modifications.max_res
  in Piqirun.gen_record code [ _wizard; _max_res ]
and gen__correspondance_family code x =
  let _index =
    Piqirun.gen_required_field 1 gen__protobuf_int32
      x.Correspondance_family.index in
  let _spouse =
    Piqirun.gen_required_field 2 gen__person x.Correspondance_family.spouse in
  let _children =
    Piqirun.gen_repeated_field 3 gen__person x.Correspondance_family.children
  in Piqirun.gen_record code [ _index; _spouse; _children ]
and gen__correspondance code x =
  let _base =
    Piqirun.gen_required_field 1 gen__string x.Correspondance.base in
  let _person =
    Piqirun.gen_required_field 2 gen__person x.Correspondance.person in
  let _father =
    Piqirun.gen_optional_field 3 gen__person x.Correspondance.father in
  let _mother =
    Piqirun.gen_optional_field 4 gen__person x.Correspondance.mother in
  let _families =
    Piqirun.gen_repeated_field 5 gen__correspondance_family
      x.Correspondance.families
  in Piqirun.gen_record code [ _base; _person; _father; _mother; _families ]
and gen__correspondance_list code x =
  let _correspondances =
    Piqirun.gen_repeated_field 1 gen__correspondance
      x.Correspondance_list.correspondances
  in Piqirun.gen_record code [ _correspondances ]
and gen__sex code x =
...
and gen__title_type code x =
  Piqirun.int32_to_signed_varint code
    (match x with | `title_main -> 0l | `title_name -> 1l | `title_none -> 2l)
...
let gen_warning_bad_sex_of_married_person x =
  gen__warning_bad_sex_of_married_person (-1) x
...
let gen_warning_changed_order_of_children x =
  gen__warning_changed_order_of_children (-1) x
  
let gen_warning_changed_order_of_marriages x =
  gen__warning_changed_order_of_marriages (-1) x
  
let gen_warning_children_not_in_order x =
  gen__warning_children_not_in_order (-1) x
  
let gen_warning_dead_too_early_to_be_father x =
  gen__warning_dead_too_early_to_be_father (-1) x
  
let gen_warning_incoherent_ancestor_date x =
  gen__warning_incoherent_ancestor_date (-1) x
  
let gen_warning_marriage_date_after_death x =
  gen__warning_marriage_date_after_death (-1) x
  
let gen_warning_marriage_date_before_birth x =
  gen__warning_marriage_date_before_birth (-1) x
  
let gen_warning_mother_dead_before_child_birth x =
  gen__warning_mother_dead_before_child_birth (-1) x
  
let gen_warning_parent_born_after_child x =
  gen__warning_parent_born_after_child (-1) x
...
let gen_warning_big_age_between_spouses x =
  gen__warning_big_age_between_spouses (-1) x
  
let gen_warning_dead_old x = gen__warning_dead_old (-1) x
  
let gen_warning_old_individual x = gen__warning_old_individual (-1) x
  
let gen_warning_witness_date_after_death x =
  gen__warning_witness_date_after_death (-1) x
  
let gen_warning_witness_date_before_birth x =
  gen__warning_witness_date_before_birth (-1) x
  
let gen_warning_changed_order_of_family_events x =
  gen__warning_changed_order_of_family_events (-1) x
  
let gen_warning_changed_order_of_person_events x =
  gen__warning_changed_order_of_person_events (-1) x
  
let gen_warning_fevent_order x = gen__warning_fevent_order (-1) x
  
let gen_warning_fwitness_event_after_death x =
  gen__warning_fwitness_event_after_death (-1) x
  
let gen_warning_fwitness_event_before_birth x =
  gen__warning_fwitness_event_before_birth (-1) x
  
let gen_warning_pevent_order x = gen__warning_pevent_order (-1) x
  
let gen_warning_pwitness_event_after_death x =
  gen__warning_pwitness_event_after_death (-1) x
  
let gen_warning_pwitness_event_before_birth x =
  gen__warning_pwitness_event_before_birth (-1) x
...
let gen_notification_birthday_params x =
  gen__notification_birthday_params (-1) x
