...
and parse_event x =
  ...
  let _date_conv, x = Piqirun.parse_optional_field 4 parse_string x in
  let _date_cal, x = Piqirun.parse_optional_field 5 parse_calendar x in
  let _place, x = Piqirun.parse_optional_field 6 parse_string x in
  let _reason, x = Piqirun.parse_optional_field 7 parse_string x in
  let _note, x = Piqirun.parse_optional_field 8 parse_string x in
  let _src, x = Piqirun.parse_optional_field 9 parse_string x in
  let _spouse, x = Piqirun.parse_optional_field 10 parse_simple_person x in
  let _witnesses, x = Piqirun.parse_repeated_field 11 parse_witness_event x in
  let _date_raw, x = Piqirun.parse_optional_field 12 parse_string x in
  Piqirun.check_unparsed_fields x;
  {
    Event.name = _name;
    Event.type_ = _type_;
...
and parse_family x =
  ...
  let _marriage_date_raw, x = Piqirun.parse_optional_field 17 parse_string x in
  let _divorce_date_raw, x = Piqirun.parse_optional_field 18 parse_string x in
  Piqirun.check_unparsed_fields x;
  {
    Family.index = _index;
...
and gen__event code x =
  ...
  let _date_conv = Piqirun.gen_optional_field 4 gen__string x.Event.date_conv in
  let _date_cal = Piqirun.gen_optional_field 5 gen__calendar x.Event.date_cal in
  let _place = Piqirun.gen_optional_field 6 gen__string x.Event.place in
  let _reason = Piqirun.gen_optional_field 7 gen__string x.Event.reason in
  let _note = Piqirun.gen_optional_field 8 gen__string x.Event.note in
  let _src = Piqirun.gen_optional_field 9 gen__string x.Event.src in
  let _spouse = Piqirun.gen_optional_field 10 gen__simple_person x.Event.spouse in
  let _witnesses = Piqirun.gen_repeated_field 11 gen__witness_event x.Event.witnesses in
  let _date_raw = Piqirun.gen_optional_field 12 gen__string x.Event.date_raw in
  Piqirun.gen_record code (_name :: _type_ :: _date :: _date_conv :: _date_cal :: _place :: _reason :: _note :: _src :: _spouse :: _witnesses :: _date_raw :: [])
...
and gen__simple_person code x =
  ...
  Piqirun.gen_record code (_index :: _sex :: _lastname :: _firstname :: _n :: _p :: _occ :: _birth_short_date :: _birth_place :: _death_short_date :: _death_place :: _image :: _sosa :: _baseprefix :: _birth_date_raw :: _death_date_raw :: [])
...
and gen__fiche_person code x =
  ...
  Piqirun.gen_record code (_birth_date_raw :: _birth_text :: _baptism_date_raw :: _baptism_text :: _death_date_raw :: _death_text :: _burial_date_raw :: _burial_text :: _cremation_text :: _burial_type :: _titles_links :: _sosa_nb :: _has_history :: _has_possible_duplications :: _ref_index :: _linked_page_biblio :: _linked_page_bnote :: _linked_page_death :: _linked_page_head :: _linked_page_occu :: _visible_for_visitors :: _father :: _mother :: [])
...
and gen__family code x =
  ...
  let _marriage_date_raw = Piqirun.gen_optional_field 17 gen__string x.Family.marriage_date_raw in
  let _divorce_date_raw = Piqirun.gen_optional_field 18 gen__string x.Family.divorce_date_raw in
  Piqirun.gen_record code (_index :: _spouse :: _marriage_date :: _marriage_date_conv :: _marriage_date_cal :: _marriage_place :: _marriage_src :: _marriage_type :: _divorce_type :: _divorce_date :: _divorce_date_conv :: _divorce_date_cal :: _witnesses :: _notes :: _fsources :: _children :: _marriage_date_raw :: _divorce_date_raw :: [])
...
and gen__identifier_person code x =
  ...
  Piqirun.gen_record code (_index :: _n :: _p :: _oc :: [])
