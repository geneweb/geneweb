...
and parse_graph_tree x =
  ...
  Piqirun.check_unparsed_fields x;
  {
    ...
    Graph_tree.nodes_siblings_before = _nodes_siblings_before;
    Graph_tree.nodes_siblings_after = _nodes_siblings_after;
  }
...
and gen__graph_tree code x =
  ...
  let _nodes_siblings_before = Piqirun.gen_repeated_field 6 gen__node x.Graph_tree.nodes_siblings_before in
  let _nodes_siblings_after = Piqirun.gen_repeated_field 7 gen__node x.Graph_tree.nodes_siblings_after in
...
and default_graph_tree () =
  {
    ...
    Graph_tree.nodes_siblings_before = [];
    Graph_tree.nodes_siblings_after = [];
  }
