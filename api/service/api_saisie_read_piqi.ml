...
and gen__person_tree code x =
  ...
  Piqirun.gen_record code (_index :: _sex :: _lastname :: _firstname :: _n :: _p :: _occ :: _dates :: _image :: _sosa :: _has_more_infos :: [])
...
and gen__simple_person code x =
  ...
  Piqirun.gen_record code (_index :: _sex :: _lastname :: _firstname :: _n :: _p :: _occ :: _birth_short_date :: _birth_place :: _death_short_date :: _death_place :: _image :: _sosa :: [])
