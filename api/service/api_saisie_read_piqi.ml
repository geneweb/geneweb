...
and gen__simple_person code x =
  ...
  Piqirun.gen_record code (_index :: _sex :: _lastname :: _firstname :: _n :: _p :: _occ :: _birth_short_date :: _birth_place :: _death_short_date :: _death_place :: _image :: _sosa :: _baseprefix :: _birth_date_raw :: _death_date_raw :: _sosa_nb :: _visible_for_visitors :: [])
