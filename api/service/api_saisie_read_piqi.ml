...
and gen__event code x =
  ...
  Piqirun.gen_record code (_name :: _type_ :: _date :: _date_long :: _date_conv :: _date_cal :: _place :: _reason :: _note :: _src :: _spouse :: _witnesses :: _date_raw :: [])
...
and gen__simple_person code x =
  ...
  Piqirun.gen_record code (_index :: _sex :: _lastname :: _firstname :: _n :: _p :: _occ :: _birth_short_date :: _birth_place :: _death_short_date :: _death_place :: _image :: _sosa :: _baseprefix :: _birth_date_raw :: _death_date_raw :: _sosa_nb :: [])
