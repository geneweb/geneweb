...
and parse_event x =
  ...
  let _date_raw, x = Piqirun.parse_optional_field 11 parse_string x in
  Piqirun.check_unparsed_fields x;
  {
    Event.name = _name;
    Event.date = _date;
...
and parse_identifier_person x =
  ...
  let _sosa_nb, x = Piqirun.parse_optional_field 2 parse_string x in
  Piqirun.check_unparsed_fields x;
  {
    Identifier_person.index = _index;
    Identifier_person.sosa_nb = _sosa_nb;
  }
...
and gen__event code x =
  ...
  let _date_raw = Piqirun.gen_optional_field 11 gen__string x.Event.date_raw in
  Piqirun.gen_record code (_name :: _date :: _date_conv :: _date_cal :: _place :: _reason :: _note :: _src :: _spouse :: _witnesses :: _date_raw :: [])
...
and gen__identifier_person code x =
  ...
  let _sosa_nb = Piqirun.gen_optional_field 2 gen__string x.Identifier_person.sosa_nb in
  Piqirun.gen_record code (_index :: _sosa_nb :: [])
...
and default_identifier_person () =
  {
    ...
    Identifier_person.sosa_nb = None;
  }
and default_error () =
  {
