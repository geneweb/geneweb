...
let build_graph_asc_full = build_graph_asc_main pers_to_piqi_person_tree_full make_node_full
let build_graph_desc_full = build_graph_desc_main pers_to_piqi_person_tree_full make_node_full
