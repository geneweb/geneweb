...
and gen__person_search code x =
  ...
  Piqirun.gen_record code (_index :: _sex :: _lastname :: _firstname :: _dates :: _image :: _sosa :: _family :: [])
...
and gen__modification_status code x =
  ...
  Piqirun.gen_record code (_is_base_updated :: _base_warnings :: _index_person :: _lastname :: _firstname :: _occ :: _index_family :: _conflict :: _lastname_str :: _firstname_str :: _n :: _p :: [])
