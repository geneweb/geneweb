To start with GeneWeb, you first need to execute some commands.

The simplest way is to launch the "gwsetup" program. It allows you to
execute these commands by using your Web browser. All is explained
in the navigation.
