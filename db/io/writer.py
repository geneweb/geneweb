...
from typing import List, Dict, Set, Callable, BinaryIO, Tuple
import struct
import pickle
import hashlib
...
class DatabaseWriter:
    ...
    def make_strings_of_fname(self, persons: List[any], strings: List[str]) -> List[List[int]]:
        """
        Create index of string IDs for firstname substrings.
        Matches OCaml make_strings_of_fname.
        """
        return self._make_strings_of_name(
            persons,
            lambda p: p.first_name,
            strings
        )

    def make_strings_of_sname(self, persons: List[any], strings: List[str]) -> List[List[int]]:
        """
