(* $Id: update_nldb.ml,v 1.00 2013-09-10 11:24:41 flh Exp $ *)
(* wrapper *)
...
value update_nldb_moins = Filename.concat (Filename.dirname Sys.argv.(0)) "../../gw_moins/gw/update_nldb";
value update_nldb_plus = Filename.concat (Filename.dirname Sys.argv.(0)) "../../gw_plus/gw/update_nldb";
