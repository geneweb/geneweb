...
(* $Id: ged2gwb.ml,v 1.00 2013-09-10 11:12:11 flh Exp $ *)
(* wrapper *)
...
value ged2gwb_moins = Filename.concat (Filename.dirname Sys.argv.(0)) "../../gw_moins/gw/ged2gwb";
value ged2gwb_plus = Filename.concat (Filename.dirname Sys.argv.(0)) "../../gw_plus/gw/ged2gwb";
