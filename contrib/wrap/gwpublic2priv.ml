(* $Id: gwpublic2priv.ml,v 1.00 2013-09-10 11:23:08 flh Exp $ *)
(* wrapper *)
...
value gwpublic2priv_moins = Filename.concat (Filename.dirname Sys.argv.(0)) "../../gw_moins/gw/gwpublic2priv";
value gwpublic2priv_plus = Filename.concat (Filename.dirname Sys.argv.(0)) "../../gw_plus/gw/gwpublic2priv";
