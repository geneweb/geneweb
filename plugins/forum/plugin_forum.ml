...
let () =
  Gwd_lib.GwdPlugin.register ~ns
    [
      ...
      ( "FORUM_ADD_OK",
        fun _assets -> w_base @@ wrapper ForumDisplay.print_add_ok );
      ("FORUM_DEL", fun _assets -> w_base @@ wrapper ForumDisplay.print_del);
      ( "FORUM_P_P",
        fun _assets -> w_base @@ wrapper ForumDisplay.print_access_switch );
      ( "FORUM_SEARCH",
        fun _assets -> w_base @@ wrapper ForumDisplay.print_search );
