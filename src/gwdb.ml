...
value istr2_fun =
  {is_empty_string (db2, path, pos) = string_of_istr2 db2 path pos = "";
   is_quest_string (db2, path, pos) = string_of_istr2 db2 path pos = "?";
...
value get_baptism_place p =
  ...
  wrap_per f f f p
;
value get_baptism_note p =
  let f pf = pf.get_baptism_note in
  wrap_per f f f p
;
...
value get_birth_place p =
  ...
  wrap_per f f f p
;
value get_birth_note p =
  let f pf = pf.get_birth_note in
  wrap_per f f f p
;
...
value get_burial_place p =
  ...
  wrap_per f f f p
;
value get_burial_note p =
  let f pf = pf.get_burial_note in
  wrap_per f f f p
;
...
value get_death_place p =
  ...
  wrap_per f f f p
;
value get_death_note p =
  let f pf = pf.get_death_note in
  wrap_per f f f p
;
...
value get_fsources fam =
  ...
  wrap_fam f f f fam
;
value get_fevents fam =
  let f pf = pf.get_fevents in
  wrap_fam f f f fam
;
...
value get_marriage_place fam =
  ...
  wrap_fam f f f fam
;
value get_marriage_note fam =
  let f pf = pf.get_marriage_note in
  wrap_fam f f f fam
;
      ...
      | allowed_titles ->
          ...
          | denied_titles ->
              List.filter
                ...
                list ] ]
    ;
    value p_first_name self p = Mutil.nominative (self.sou (get_first_name p));
    value p_surname self p = Mutil.nominative (self.sou (get_surname p));
  end
;
