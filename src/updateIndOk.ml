(* camlp4r ./pa_html.cmo *)
(* $Id: updateIndOk.ml,v 5.22 2006-10-03 03:42:33 ddr Exp $ *)
...
value effective_mod conf base sp =
  ...
  do {
    ...
    let op_misc_names = Util.person_misc_names conf base op in
    let np_misc_names = Util.person_misc_names conf base np in
    List.iter
      (fun key ->
