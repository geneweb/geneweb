...
class BinarySearch:
    ...
    @staticmethod
    def find_first(
        items: List[T], key: T, compare: Callable[[T, T], int]
    ) -> Optional[int]:
        """
    ...
    @staticmethod
    def find_range(items: List[T], key: T, compare: Callable[[T, T], int]) -> List[int]:
        """
    ...
    @staticmethod
    def lower_bound(items: List[T], key: T, compare: Callable[[T, T], int]) -> int:
        """
