"""
Integration tests for MessagePack module.
"""
...
class TestDatabaseIntegration:
    ...
    def test_save_load_complete_workflow(self, populated_database):
        ...
        try:
            ...
            # Save database
            writer.write_database(populated_database, "test_save_load")

            # Load database
            loaded_db = reader.load_database("test_save_load")
    ...
    def test_compressed_save_load_workflow(self, populated_database):
        ...
        try:
            ...
            # Save database
            writer.write_database(populated_database, "test_compressed")

            # Load database
            loaded_db = reader.load_database("test_compressed")
    ...
    def test_large_dataset_workflow(self):
        ...
        try:
            ...
            # Save
            writer.write_database(db, "test_large_dataset")

            # Load
            loaded_db = reader.load_database("test_large_dataset")
    ...
    def test_error_handling_workflow(self):
        ...
        try:
            ...
            writer.write_database(db, "test_error_handling")

            # Load should work
            loaded_db = reader.load_database("test_error_handling")
