...
class GedcomExporter:
    ...
    def export_file(
        self, filepath: Path, database: GedcomDatabase, encoding: str = "utf-8"
    ) -> None:
        """
            ...
            try:
                ...
                if record:
                    ...
                    if exporter:
                        ...
                        self.logger.warning(
                            f"No exporter found for record type: {record_type}"
                        )
            except Exception as e:
    ...
    def _get_record(
        self, database: GedcomDatabase, record_type: str, xref: str
    ) -> Optional[object]:
