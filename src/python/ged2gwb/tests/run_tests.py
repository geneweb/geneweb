...
def run_test_suite():
    ...
    print("-" * 30)
    try:
        from ged2gwb.tests.test_options import main as test_options
    ...
    print("-" * 30)
    try:
        from ged2gwb.tests.test_conversion import main as test_conversion
    ...
    print("-" * 30)
    try:
        from ged2gwb.tests.test_integration import main as test_integration
    ...
    print("-" * 30)
    try:
        from ged2gwb.tests.test_concrete import main as test_concrete
