...
class SourceParser(RecordParser):
    ...
    def parse(self, lines: List[GedcomLine], start_index: int) -> tuple:
        ...
        while current_index < len(lines):
            ...
            elif line.tag == 'CONC' and current_data_record is not None and 'text' in current_data_record:
                current_data_record['text'] += line.value
            elif line.tag == 'CONT' and current_data_record is not None and 'text' in current_data_record:
