...
from ..models import (
    GedcomDate, GedcomPlace, GedcomEvent, GedcomName, GedcomIndividual,
    GedcomFamily, GedcomDatabase, GedcomHeader, GedcomSex, GedcomDateType
)
...
class TestGedcomDatabase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        john = GedcomIndividual(xref="@I1@", names=[GedcomName(full="John Doe")], sex="M")
        jane = GedcomIndividual(xref="@I2@", names=[GedcomName(full="Jane Smith")], sex="F")
        baby = GedcomIndividual(xref="@I3@", names=[GedcomName(full="Baby Doe")], sex="M")
