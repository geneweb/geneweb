...
class TestAdvancedFunctionality(unittest.TestCase):
    ...
    def test_complex_date_parsing(self):
        ...
        # Test marriage date (estimated) - check in events list
    ...
    def test_source_citations_parsing(self):
        ...
        self.assertTrue(any(line[1] == 'PAGE' and line[2] == 'Page 101112' for line in source_citation.sub_lines))
        self.assertTrue(any(line[1] == '_LINK' and line[2] == 'https://example.com/s4' for line in source_citation.sub_lines))
    ...
    def test_multimedia_parsing(self):
        ...
        self.assertEqual(multimedia1.notes[0], 'This is John\'s portrait\ntaken in 1920and shows him in his prime')
        ...
        self.assertEqual(multimedia2.notes[0], 'Official birth certificate\nfrom New York Stateshowing all details')
    ...
    def test_notes_parsing(self):
        ...
        self.assertEqual(individual.notes[0], 'This is a test individual\nwith multiple lines')
