...
from lib.db_pickle.core.types import Iper, Ifam
...
def find_descendants(data: PickleBaseData, person_id: Iper, max_generations: int = 10) -> list[Iper]:
...
def find_ancestors(data: PickleBaseData, person_id: Iper, max_generations: int = 10) -> list[Iper]:
...
def demonstrate_search():
    ...
    print(f"Created family tree with {data.persons_count} persons and {data.families_count} families")
    ...
    print(f"Index search is {descendant_time/index_time:.1f}x faster for simple lookups")
