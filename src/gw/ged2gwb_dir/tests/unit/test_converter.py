...
"""
    ...
    @patch('lib.ged2gwb.core.converter.GedcomToGenewebConverter')
    @patch('lib.ged2gwb.core.converter.create_parser')
...
def main():
    ...
    test_methods = [method for method in dir(converter_tests) if method.startswith('test_')]
