...
class TestConversionOptions:
    ...
    def test_udi_conversion(self):
        ...
        for attr in ['output', 'charset', 'dates_dm', 'dates_md', 'no_nd',
                    'efn', 'epn', 'no_efn', 'no_epn', 'fne', 'lf', 'ls', 'us',
                    'particles', 'ds', 'rs_no_mention', 'no_pit', 'nopicture',
                    'uin', 'tnd', 'compress', 'force', 'verbose', 'trackid',
                    'no_consistency_check', 'nc', 'base_dir']:
            setattr(args, attr, None if attr in ['output', 'charset', 'fne', 'particles', 'ds', 'base_dir'] else False)
    ...
    def test_udi_invalid_format(self):
        ...
        try:
            ...
            assert "must be a tuple" in str(e) or "Invalid UDI format" in str(e) or "udi" in str(e).lower()
...
def main():
    ...
    test_methods = [method for method in dir(options_tests) if method.startswith('test_')]
