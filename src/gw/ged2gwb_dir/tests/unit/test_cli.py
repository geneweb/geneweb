...
class TestGed2GwbCLI:
    ...
    def test_required_options_present(self):
        ...
        required_options = [
            "--charset", "--dates-dm", "--dates-md", "--efn", "--epn",
            "--lf", "--ls", "--output", "--compress", "--force", "--verbose"
        ]
...
def main():
    ...
    options_test_methods = [method for method in dir(options_tests) if method.startswith('test_')]
