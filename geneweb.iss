...
; Modernized for GitHub Actions CI
; Original script from 2012, updated 2025
...
[Icons]
; Start Menu icons
Name: "{group}\GeneWeb Server (gwd)"; Filename: "{app}\gwd.bat"; WorkingDir: "{app}"; Flags: runminimized; Comment: "Start GeneWeb server"
Name: "{group}\GeneWeb Setup (gwsetup)"; Filename: "{app}\gwsetup.bat"; WorkingDir: "{app}"; Flags: runminimized; Comment: "GeneWeb configuration wizard"
...
Name: "{autodesktop}\GeneWeb Server"; Filename: "{app}\gwd.bat"; WorkingDir: "{app}"; Tasks: desktopicon; Flags: runminimized; Comment: "Start GeneWeb server"
Name: "{autodesktop}\GeneWeb Setup"; Filename: "{app}\gwsetup.bat"; WorkingDir: "{app}"; Tasks: desktopicon; Flags: runminimized; Comment: "GeneWeb configuration"
