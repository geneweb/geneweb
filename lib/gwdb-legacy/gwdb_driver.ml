...
let persons_of_lower_first_name base = base.func.Dbdisk.persons_of_lower_first_name
let persons_of_lower_surname base = base.func.Dbdisk.persons_of_lower_surname
...
let base_strings_of_first_name_prefix base s = base.func.strings_of_fname_prefix s
let base_strings_of_surname_prefix base s = base.func.strings_of_sname_prefix s
