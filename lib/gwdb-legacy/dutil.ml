...
let fpath fname tmp base =
  let fname = if tmp then tmp_fname fname else fname in
...
let snames_dat = fpath snames_dat
let snames_inx = fpath snames_inx
let snames_lower_dat = fpath snames_lower_dat
let snames_lower_inx = fpath snames_lower_inx
...
let snames_marital_dat = fpath snames_marital_dat
let snames_marital_inx = fpath snames_marital_inx
let snames_marital_lower_dat = fpath snames_marital_lower_dat
let snames_marital_lower_inx = fpath snames_marital_lower_inx
