...
let sdn_of_gregorian (d : Def.dmy) = Calendars.sdn_of_gregorian @@ to_calendars d
let gregorian_of_sdn prec sdn = of_calendars ~prec @@ Calendars.gregorian_of_sdn sdn
...
let dmy_of_dmy2 : Def.dmy2 -> Def.dmy =
  ...
  { Def.day = day2 ; month = month2 ; year = year2 ; prec = Def.Sure ; delta = delta2 }
...
type moon_phase = Calendars.moon_phase = NewMoon | FirstQuarter | FullMoon | LastQuarter
