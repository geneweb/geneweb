...
and parse_serie x =
  match Piqirun.int32_of_signed_varint x with
    ...
    | 46l -> `serie_libra
    | 47l -> `serie_scorpio
    | 48l -> `serie_sagittarius
    | 49l -> `serie_capricorn
    | 50l -> `serie_aquarius
    | 51l -> `serie_pisces
    | 52l -> `serie_moon_new
    | 53l -> `serie_moon_first_quarter
    | 54l -> `serie_moon_full
    | 55l -> `serie_moon_last_quarter
    | x -> Piqirun.error_enum_const x
...
and gen__serie code x =
  Piqirun.int32_to_signed_varint code (match x with
    ...
    | `serie_libra -> 46l
    | `serie_scorpio -> 47l
    | `serie_sagittarius -> 48l
    | `serie_capricorn -> 49l
    | `serie_aquarius -> 50l
    | `serie_pisces -> 51l
    | `serie_moon_new -> 52l
    | `serie_moon_first_quarter -> 53l
    | `serie_moon_full -> 54l
    | `serie_moon_last_quarter -> 55l
  )
