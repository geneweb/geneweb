...
(** [exists fname] Returns whether [fname] exists. *)
...
(** [check_magics magics ic] Given a list of magic strings [magics] returns true
    if for one of the strings s [check_magic s ic] returns [true], [false]
    otherwise *)
