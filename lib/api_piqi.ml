...
and Warning_possible_duplicate_fam:
  sig
    type t = {
      mutable family1: Api_piqi.full_family;
      mutable family2: Api_piqi.full_family;
    }
...
and parse_warning_possible_duplicate_fam x =
  let x = Piqirun.parse_record x in
  let _family1, x = Piqirun.parse_required_field 1 parse_full_family x in
  let _family2, x = Piqirun.parse_required_field 2 parse_full_family x in
  Piqirun.check_unparsed_fields x;
  {
    Warning_possible_duplicate_fam.family1 = _family1;
    Warning_possible_duplicate_fam.family2 = _family2;
  }
...
and gen__warning_possible_duplicate_fam code x =
  let _family1 = Piqirun.gen_required_field 1 gen__full_family x.Warning_possible_duplicate_fam.family1 in
  let _family2 = Piqirun.gen_required_field 2 gen__full_family x.Warning_possible_duplicate_fam.family2 in
  Piqirun.gen_record code (_family1 :: _family2 :: [])
...
and default_warning_possible_duplicate_fam () =
  {
    Warning_possible_duplicate_fam.family1 = default_full_family ();
    Warning_possible_duplicate_fam.family2 = default_full_family ();
  }
