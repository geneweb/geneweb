...
val reconstitute_date : config -> string -> Geneweb_util.Date.date option
val print_someone : config -> base -> person -> unit
val update_conf : config -> config
val bad_date : config -> Geneweb_util.Date.dmy -> 'a
val check_greg_day : config -> Geneweb_util.Date.dmy -> unit
