module rec Api_saisie_read_piqi:
  sig
    ...
    type dmy = Dmy.t
    type date = Date.t
    type fiche_parameters = Fiche_parameters.t
...
and Fiche_parameters:
  sig
    type t = {
      ...
      mutable simple_graph_info: bool option;
      mutable no_event: bool option;
    }
  end = Fiche_parameters
and Witness_event:
  sig
    type t = {
...
and Fiche_person:
  sig
    type t = {
      ...
      mutable ref_person: Api_saisie_read_piqi.person option;
...
and parse_fiche_parameters x =
  let x = Piqirun.parse_record x in
  let _identifier_person, x = Piqirun.parse_required_field 1 parse_identifier_person x in
  let _nb_asc_max, x = Piqirun.parse_optional_field 2 parse_protobuf_int32 x in
  let _nb_desc_max, x = Piqirun.parse_optional_field 3 parse_protobuf_int32 x in
  let _simple_graph_info, x = Piqirun.parse_optional_field 4 parse_bool x in
  let _no_event, x = Piqirun.parse_optional_field 5 parse_bool x in
  Piqirun.check_unparsed_fields x;
  {
    Fiche_parameters.identifier_person = _identifier_person;
    Fiche_parameters.nb_asc_max = _nb_asc_max;
    Fiche_parameters.nb_desc_max = _nb_desc_max;
    Fiche_parameters.simple_graph_info = _simple_graph_info;
    Fiche_parameters.no_event = _no_event;
  }
...
and parse_fiche_person x =
  ...
  let _ref_person, x = Piqirun.parse_optional_field 16 parse_person x in
  let _linked_page_biblio, x = Piqirun.parse_required_field 17 parse_string x in
  let _linked_page_bnote, x = Piqirun.parse_required_field 18 parse_string x in
  let _linked_page_death, x = Piqirun.parse_required_field 19 parse_string x in
  let _linked_page_head, x = Piqirun.parse_required_field 20 parse_string x in
  let _linked_page_occu, x = Piqirun.parse_required_field 21 parse_string x in
  let _visible_for_visitors, x = Piqirun.parse_required_field 22 parse_bool x in
  let _father, x = Piqirun.parse_optional_field 23 parse_person x in
  let _mother, x = Piqirun.parse_optional_field 24 parse_person x in
  let _families, x = Piqirun.parse_repeated_field 25 parse_fiche_family x in
  let _related, x = Piqirun.parse_repeated_field 26 parse_relation_fiche_person x in
  let _rparents, x = Piqirun.parse_repeated_field 27 parse_relation_fiche_person x in
  let _events_witnesses, x = Piqirun.parse_repeated_field 28 parse_event_fiche_witness x in
  let _events, x = Piqirun.parse_repeated_field 29 parse_fiche_event x in
  Piqirun.check_unparsed_fields x;
  {
    ...
    Fiche_person.ref_person = _ref_person;
...
and gen__fiche_parameters code x =
  let _identifier_person = Piqirun.gen_required_field 1 gen__identifier_person x.Fiche_parameters.identifier_person in
  let _nb_asc_max = Piqirun.gen_optional_field 2 gen__protobuf_int32 x.Fiche_parameters.nb_asc_max in
  let _nb_desc_max = Piqirun.gen_optional_field 3 gen__protobuf_int32 x.Fiche_parameters.nb_desc_max in
  let _simple_graph_info = Piqirun.gen_optional_field 4 gen__bool x.Fiche_parameters.simple_graph_info in
  let _no_event = Piqirun.gen_optional_field 5 gen__bool x.Fiche_parameters.no_event in
  Piqirun.gen_record code (_identifier_person :: _nb_asc_max :: _nb_desc_max :: _simple_graph_info :: _no_event :: [])
...
and gen__fiche_person code x =
  ...
  let _ref_person = Piqirun.gen_optional_field 16 gen__person x.Fiche_person.ref_person in
  let _linked_page_biblio = Piqirun.gen_required_field 17 gen__string x.Fiche_person.linked_page_biblio in
  let _linked_page_bnote = Piqirun.gen_required_field 18 gen__string x.Fiche_person.linked_page_bnote in
  let _linked_page_death = Piqirun.gen_required_field 19 gen__string x.Fiche_person.linked_page_death in
  let _linked_page_head = Piqirun.gen_required_field 20 gen__string x.Fiche_person.linked_page_head in
  let _linked_page_occu = Piqirun.gen_required_field 21 gen__string x.Fiche_person.linked_page_occu in
  let _visible_for_visitors = Piqirun.gen_required_field 22 gen__bool x.Fiche_person.visible_for_visitors in
  let _father = Piqirun.gen_optional_field 23 gen__person x.Fiche_person.father in
  let _mother = Piqirun.gen_optional_field 24 gen__person x.Fiche_person.mother in
  let _families = Piqirun.gen_repeated_field 25 gen__fiche_family x.Fiche_person.families in
  let _related = Piqirun.gen_repeated_field 26 gen__relation_fiche_person x.Fiche_person.related in
  let _rparents = Piqirun.gen_repeated_field 27 gen__relation_fiche_person x.Fiche_person.rparents in
  let _events_witnesses = Piqirun.gen_repeated_field 28 gen__event_fiche_witness x.Fiche_person.events_witnesses in
  let _events = Piqirun.gen_repeated_field 29 gen__fiche_event x.Fiche_person.events in
  Piqirun.gen_record code (_birth_date_raw :: _birth_text :: _baptism_date_raw :: _baptism_text :: _death_date_raw :: _death_text :: _burial_date_raw :: _burial_text :: _cremation_text :: _burial_type :: _titles_links :: _sosa_nb :: _has_history :: _has_possible_duplications :: _ref_index :: _ref_person :: _linked_page_biblio :: _linked_page_bnote :: _linked_page_death :: _linked_page_head :: _linked_page_occu :: _visible_for_visitors :: _father :: _mother :: _families :: _related :: _rparents :: _events_witnesses :: _events :: [])
...
and gen__identifier_person code x =
  ...
  Piqirun.gen_record code (_index :: _n :: _p :: _oc :: _track_visit :: [])
...
let gen_fiche_parameters x = gen__fiche_parameters (-1) x
...
and default_fiche_parameters () =
  {
    Fiche_parameters.identifier_person = default_identifier_person ();
    Fiche_parameters.nb_asc_max = None;
    Fiche_parameters.nb_desc_max = None;
    Fiche_parameters.simple_graph_info = None;
    Fiche_parameters.no_event = None;
  }
