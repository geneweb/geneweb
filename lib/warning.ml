...
type ('iper, 'person, 'family, 'descend, 'title, 'pevent, 'fevent) warning =
  ...
  | DeadOld of 'person * Geneweb_util.Date.dmy
  ...
  | ParentTooOld of 'person * Geneweb_util.Date.dmy * 'person
      (** Person became a parent at age older then 55 years for mother and 70 for father *)
  | ParentTooYoung of 'person * Geneweb_util.Date.dmy * 'person
  ...
  | YoungForMarriage of 'person * Geneweb_util.Date.dmy * 'family
      (** Person is married before he was 12 years old *)
  | OldForMarriage of 'person * Geneweb_util.Date.dmy * 'family
