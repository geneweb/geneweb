...
let get_pevent_name _ = assert false
let get_pevent_date _ = assert false
let get_pevent_place _ = assert false
let get_pevent_reason _ = assert false
let get_pevent_note _ = assert false
let get_pevent_src _ = assert false
let get_pevent_witnesses _ = assert false
let get_pevent_witness_notes _ = assert false
let get_pevent_witnesses_and_notes _ = assert false
let gen_pevent_of_pers_event _ = assert false
let pers_event_of_gen_pevent _ = assert false
let eq_pevent _ = assert false
let get_fevent_name _ = assert false
let get_fevent_date _ = assert false
let get_fevent_place _ = assert false
let get_fevent_reason _ = assert false
let get_fevent_note _ = assert false
let get_fevent_src _ = assert false
let get_fevent_witnesses _ = assert false
let get_fevent_witness_notes _ = assert false
let get_fevent_witnesses_and_notes _ = assert false
let gen_fevent_of_fam_event _ = assert false
let fam_event_of_gen_fevent _ = assert false
let eq_fevent _ = assert false
