...
let commit_notes base fname s = () (* TODO *)
...
let base_notes_origin_file base = "origin_file" (* TODO FIX *)
let base_notes_are_empty base fname = true (* TODO FIX *)
...
let load_ascends_array base = ()
let load_unions_array base = ()
let load_couples_array base = ()
let load_descends_array base = ()
let load_strings_array base = ()
let load_persons_array base = ()
let load_families_array base = ()
let clear_ascends_array base = ()
let clear_unions_array base = ()
let clear_couples_array base = ()
let clear_descends_array base = ()
let clear_strings_array base = ()
let clear_persons_array base = ()
let clear_families_array base = ()
