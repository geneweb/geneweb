...
INPUT_IMAGE="geneweb_icon.png"  # Votre image source
...
cp GeneWeb.icns GeneWeb.app/Contents/Resources/

# Mettre à jour Info.plist
/usr/libexec/PlistBuddy -c "Add :CFBundleIconFile string GeneWeb.icns" \
    GeneWeb.app/Contents/Info.plist 2>/dev/null || \
/usr/libexec/PlistBuddy -c "Set :CFBundleIconFile GeneWeb.icns" \
    GeneWeb.app/Contents/Info.plist
